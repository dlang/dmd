...
$(TAGGED_SRCS_FILE):
	...
	"$(MAKE)" -f mak/WINDOWS gen_tagged_srcs ARCH="x86_64" TAGGED_COPY_LIST_FILE="$(TAGGED_COPY_LIST_FILE)" TAGGED_SRCS_FILE="$(TAGGED_SRCS_FILE)" TAGGED_COPY_FILE="$(TAGGED_COPY_FILE)"
