...
version (MSVCIntrinsics)
{
            ...
            else
            {
                ...
                else version (GNU)
                {
                    ...
                    version (X86_64)
                    {
                        ...
                        enum char suffix = "bwlq"[I.sizeof.bsr];

                        /* For unsigned operands; if we have PEXT, then the target has BMI2, ergo we can use MULX. */
                        static if (unsigned && I.sizeof >= 4 && __traits(compiles, () {import gcc.builtins : __builtin_ia32_pext_si;}))
                        {
    ...
    version (X86_64)
    {
        ...
        long _div128()(long highDividend, long lowDividend, long divisor, scope long* remainder) @safe pure nothrow @nogc
        {
            if (__ctfe)
            {
                 ...
                 * would require linking with DRuntime. */
    ...
    version (X86_64_Or_X86)
    {
        ...
        version (Windows)
        {
            @trusted nothrow @nogc unittest
            {
                ...
                alias addWord = mixin("__add", prefix, "word");
                alias incByte = mixin("__inc", prefix, "byte");
                alias incDword = mixin("__inc", prefix, "dword");
                alias incWord = mixin("__inc", prefix, "word");
                alias readByte = mixin("__read", prefix, "byte");
                alias readDword = mixin("__read", prefix, "dword");
                alias readWord = mixin("__read", prefix, "word");
                alias readQword = mixin("__read", prefix, "qword");
                alias writeByte = mixin("__write", prefix, "byte");
                alias writeDword = mixin("__write", prefix, "dword");
                alias writeWord = mixin("__write", prefix, "word");
                alias writeQword = mixin("__write", prefix, "qword");
    ...
    extern(C)
    pragma(inline, true)
    int _interlockedadd()(scope int* Addend, int Value) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    long _interlockedadd64()(scope long* Addend, long Value) @safe pure nothrow @nogc
    {
    ...
    version (AArch64_Or_ARM)
    {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedAdd_acq()(scope int* Addend, int Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedAdd_rel()(scope int* Addend, int Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedAdd_nf()(scope int* Addend, int Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAdd64_acq()(scope long* Addend, long Value) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq)(Addend, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAdd64_rel()(scope long* Addend, long Value) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq_rel)(Addend, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAdd64_nf()(scope long* Addend, long Value) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.raw)(Addend, Value);
        }
    }
    ...
    @trusted pure nothrow @nogc unittest
    {
        static bool test()
        {
            int intValue = 0x2ACD0123;
            long longValue = 0x12345678_2ACD0123;
    ...
    version (X86)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedAddLargeStatistic()(scope long* Addend, int Value) @safe pure nothrow @nogc
        {
            if (__ctfe)
            {
                *Addend += Value;
            ...
            else
            {
                version (LDC)
                {
                    ...
                    scope highHalf = ((a) @trusted => &(cast(uint*) Addend)[1])(Addend);
        ...
        @safe pure nothrow @nogc unittest
        {
            static bool test()
            {
                long value = 0x12345678_2ACD0123;
    ...
    extern(C)
    pragma(inline, true)
    int _InterlockedAnd()(scope int* value, int mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    byte _InterlockedAnd8()(scope byte* value, byte mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    short _InterlockedAnd16()(scope short* value, short mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    long _interlockedand64()(scope long* value, long mask) @safe pure nothrow @nogc
    {
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedAnd_acq()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedAnd_rel()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedAnd_nf()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedAnd8_acq()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedAnd8_rel()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedAnd8_nf()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedAnd16_acq()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedAnd16_rel()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedAnd16_nf()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAnd64_acq()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAnd64_rel()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAnd64_nf()(scope long* value, long mask) @safe pure nothrow @nogc
        {
    ...
    version (X86_64)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedAnd_np()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedAnd8_np()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedAnd16_np()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAnd64_np()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAnd64_HLEAcquire()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedAnd64_HLERelease()(scope long* value, long mask) @safe pure nothrow @nogc
        {
    ...
    version (X86_64_Or_X86)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedAnd_HLEAcquire()(scope int* value, int mask) @safe pure nothrow @nogc
        {
            return interlockedOpHLE!(true, "&", "and")(value, mask);
        }
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedAnd_HLERelease()(scope int* value, int mask) @safe pure nothrow @nogc
        {
            return interlockedOpHLE!(false, "&", "and")(value, mask);
        }
    }
    ...
    extern(C)
    pragma(inline, true)
    ubyte _interlockedbittestandreset()(scope int* a, int b) @system pure nothrow @nogc
    {
    ...
    version (X86_64_Or_AArch64)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset64()(scope long* a, long b) @system pure nothrow @nogc
        {
    ...
    version (X86_64_Or_X86)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset_HLEAcquire()(scope int* a, int b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset_HLERelease()(scope int* a, int b) @system pure nothrow @nogc
        {
    ...
    version (X86_64)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset64_HLEAcquire()(scope long* a, long b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset64_HLERelease()(scope long* a, long b) @system pure nothrow @nogc
        {
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset_acq()(scope int* a, int b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset_rel()(scope int* a, int b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset_nf()(scope int* a, int b) @system pure nothrow @nogc
        {
    ...
    version (AArch64)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset64_acq()(scope long* a, long b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset64_rel()(scope long* a, long b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandreset64_nf()(scope long* a, long b) @system pure nothrow @nogc
        {
    ...
    extern(C)
    pragma(inline, true)
    ubyte _interlockedbittestandset()(scope int* a, int b) @system pure nothrow @nogc
    {
    ...
    version (X86_64_Or_AArch64)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset64()(scope long* a, long b) @system pure nothrow @nogc
        {
    ...
    version (X86_64_Or_X86)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset_HLEAcquire()(scope int* a, int b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset_HLERelease()(scope int* a, int b) @system pure nothrow @nogc
        {
    ...
    version (X86_64)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset64_HLEAcquire()(scope long* a, long b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset64_HLERelease()(scope long* a, long b) @system pure nothrow @nogc
        {
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset_acq()(scope int* a, int b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset_rel()(scope int* a, int b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset_nf()(scope int* a, int b) @system pure nothrow @nogc
        {
    ...
    version (AArch64)
    {
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset64_acq()(scope long* a, long b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset64_rel()(scope long* a, long b) @system pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        ubyte _interlockedbittestandset64_nf()(scope long* a, long b) @system pure nothrow @nogc
        {
    ...
    extern(C)
    pragma(inline, true)
    int _InterlockedCompareExchange()(scope int* Destination, int Exchange, int Comparand)
    @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    byte _InterlockedCompareExchange8()(scope byte* Destination, byte Exchange, byte Comparand)
    @safe pure nothrow @nogc
    {
        return interlockedCAS(Destination, Exchange, Comparand);
    }
    ...
    extern(C)
    pragma(inline, true)
    short _InterlockedCompareExchange16()(scope short* Destination, short Exchange, short Comparand)
    @safe pure nothrow @nogc
    {
        return interlockedCAS(Destination, Exchange, Comparand);
    }
    ...
    extern(C)
    pragma(inline, true)
    long _InterlockedCompareExchange64()(scope long* Destination, long Exchange, long Comparand)
    @safe pure nothrow @nogc
    {
        return interlockedCAS(Destination, Exchange, Comparand);
    }
    ...
    version (X86_64_Or_X86)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedCompareExchange_HLEAcquire()(scope int* Destination, int Exchange, int Comparand)
        @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedCompareExchange_HLERelease()(scope int* Destination, int Exchange, int Comparand)
        @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedCompareExchange64_HLEAcquire()(scope long* Destination, long Exchange, long Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCASHLE!true(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedCompareExchange64_HLERelease()(scope long* Destination, long Exchange, long Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCASHLE!false(Destination, Exchange, Comparand);
        }
    ...
    version (X86_64)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedCompareExchange_np()(scope int* Destination, int Exchange, int Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedCompareExchange16_np()(scope short* Destination, short Exchange, short Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedCompareExchange64_np()(scope long* Destination, long Exchange, long Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS(Destination, Exchange, Comparand);
        }
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedCompareExchange_acq()(scope int* Destination, int Exchange, int Comparand)
        @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedCompareExchange_rel()(scope int* Destination, int Exchange, int Comparand)
        @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedCompareExchange_nf()(scope int* Destination, int Exchange, int Comparand)
        @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedCompareExchange8_acq()(scope byte* Destination, byte Exchange, byte Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.acq)(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedCompareExchange8_rel()(scope byte* Destination, byte Exchange, byte Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.acq_rel, MemoryOrder.raw)(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedCompareExchange8_nf()(scope byte* Destination, byte Exchange, byte Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.raw)(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedCompareExchange16_acq()(scope short* Destination, short Exchange, short Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.acq)(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedCompareExchange16_rel()(scope short* Destination, short Exchange, short Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.acq_rel, MemoryOrder.raw)(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedCompareExchange16_nf()(scope short* Destination, short Exchange, short Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.raw)(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedCompareExchange64_acq()(scope long* Destination, long Exchange, long Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.acq)(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedCompareExchange64_rel()(scope long* Destination, long Exchange, long Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.acq_rel, MemoryOrder.raw)(Destination, Exchange, Comparand);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedCompareExchange64_nf()(scope long* Destination, long Exchange, long Comparand)
        @safe pure nothrow @nogc
        {
            return interlockedCAS!(MemoryOrder.raw)(Destination, Exchange, Comparand);
        }
    ...
    @trusted pure nothrow @nogc unittest
    {
        ...
        {
            T value = cast(T) 0x6B2E38BF9FAF53EC;
    ...
    @system pure nothrow @nogc unittest
    {
        ...
        static void compareExchangeTest(alias symbol)()
        {
            ...
            scope long[2] expected;
            expected[lo] = 0x6B2E38BF9FAF53EC;
            expected[hi] = 0x5E81D5FBA4340FD3;
    ...
    @safe pure nothrow @nogc unittest
    {
        ...
        static void compareExchangeTest(alias symbol)()
        {
            ...
            scope void** valueAddress = ((return scope ref v) @trusted => cast(void**) &v)(value);
    ...
    extern(C)
    pragma(inline, true)
    int _InterlockedDecrement()(scope int* lpAddend) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    short _InterlockedDecrement16()(scope short* lpAddend) @safe pure nothrow @nogc
    {
        return interlockedAdd(lpAddend, -1);
    }
    ...
    extern(C)
    pragma(inline, true)
    long _interlockeddecrement64()(scope long* lpAddend) @safe pure nothrow @nogc
    {
        import core.internal.atomic : atomicFetchAdd;
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedDecrement_acq()(scope int* lpAddend) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedDecrement_rel()(scope int* lpAddend) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedDecrement_nf()(scope int* lpAddend) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedDecrement16_acq()(scope short* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq)(lpAddend, -1);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedDecrement16_rel()(scope short* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq_rel)(lpAddend, -1);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedDecrement16_nf()(scope short* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.raw)(lpAddend, -1);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedDecrement64_acq()(scope long* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq)(lpAddend, -1);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedDecrement64_rel()(scope long* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq_rel)(lpAddend, -1);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedDecrement64_nf()(scope long* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.raw)(lpAddend, -1);
        }
    }
    ...
    extern(C)
    pragma(inline, true)
    int _InterlockedExchange()(scope int* Target, int Value) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    byte _InterlockedExchange8()(scope byte* Target, byte Value) @safe pure nothrow @nogc
    {
        return interlockedExchange(Target, Value);
    }
    ...
    extern(C)
    pragma(inline, true)
    short _InterlockedExchange16()(scope short* Target, short Value) @safe pure nothrow @nogc
    {
        return interlockedExchange(Target, Value);
    }
    ...
    version (X86_64_Or_AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        long _InterlockedExchange64()(scope long* Target, long Value) @safe pure nothrow @nogc
        {
            return interlockedExchange(Target, Value);
        }
    }
    ...
    version (X86_64_Or_X86)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedExchange_HLEAcquire()(scope int* Target, int Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedExchange_HLERelease()(scope int* Target, int Value) @safe pure nothrow @nogc
        {
    ...
    version (X86_64)
    {
        extern(C)
        pragma(inline, true)
        long _InterlockedExchange64_HLEAcquire()(scope long* Target, long Value) @safe pure nothrow @nogc
        {
            return interlockedExchangeHLE!true(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedExchange64_HLERelease()(scope long* Target, long Value) @safe pure nothrow @nogc
        {
            return interlockedExchangeHLE!false(Target, Value);
        }
    }
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedExchange_acq()(scope int* Target, int Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedExchange_rel()(scope int* Target, int Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedExchange_nf()(scope int* Target, int Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedExchange8_acq()(scope byte* Target, byte Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.acq)(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedExchange8_rel()(scope byte* Target, byte Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.acq_rel)(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedExchange8_nf()(scope byte* Target, byte Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.raw)(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedExchange16_acq()(scope short* Target, short Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.acq)(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedExchange16_rel()(scope short* Target, short Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.acq_rel)(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedExchange16_nf()(scope short* Target, short Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.raw)(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedExchange64_acq()(scope long* Target, long Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.acq)(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedExchange64_rel()(scope long* Target, long Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.acq_rel)(Target, Value);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedExchange64_nf()(scope long* Target, long Value) @safe pure nothrow @nogc
        {
            return interlockedExchange!(MemoryOrder.raw)(Target, Value);
        }
    }
    ...
    @trusted pure nothrow @nogc unittest
    {
        ...
        {
            T value = cast(T) 0x0790C852D0938C7B;
    ...
    extern(C)
    pragma(inline, true)
    void* _InterlockedExchangePointer()(scope void** Target, scope void* Value) @safe pure nothrow @nogc
    {
    ...
    version (X86_64_Or_X86)
    {
        extern(C)
        pragma(inline, true)
        void* _InterlockedExchangePointer_HLEAcquire()(scope void** Target, scope void* Value)
        @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        void* _InterlockedExchangePointer_HLERelease()(scope void** Target, scope void* Value)
        @safe pure nothrow @nogc
        {
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        void* _InterlockedExchangePointer_acq()(scope void** Target, scope void* Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        void* _InterlockedExchangePointer_rel()(scope void** Target, scope void* Value) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        void* _InterlockedExchangePointer_nf()(scope void** Target, scope void* Value) @safe pure nothrow @nogc
        {
    ...
    extern(C)
    pragma(inline, true)
    int _InterlockedIncrement()(scope int* lpAddend) @safe pure nothrow @nogc
    {
        return interlockedAdd(lpAddend, 1);
    }
    ...
    extern(C)
    pragma(inline, true)
    short _InterlockedIncrement16()(scope short* lpAddend) @safe pure nothrow @nogc
    {
        return interlockedAdd(lpAddend, 1);
    }
    ...
    extern(C)
    pragma(inline, true)
    long _interlockedincrement64()(scope long* lpAddend) @safe pure nothrow @nogc
    {
        import core.internal.atomic : atomicFetchAdd;
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedIncrement_acq()(scope int* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq)(lpAddend, 1);
        }
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedIncrement_rel()(scope int* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq_rel)(lpAddend, 1);
        }
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedIncrement_nf()(scope int* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.raw)(lpAddend, 1);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedIncrement16_acq()(scope short* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq)(lpAddend, 1);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedIncrement16_rel()(scope short* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq_rel)(lpAddend, 1);
        }
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedIncrement16_nf()(scope short* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.raw)(lpAddend, 1);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedIncrement64_acq()(scope long* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq)(lpAddend, 1);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedIncrement64_rel()(scope long* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.acq_rel)(lpAddend, 1);
        }
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedIncrement64_nf()(scope long* lpAddend) @safe pure nothrow @nogc
        {
            return interlockedAdd!(MemoryOrder.raw)(lpAddend, 1);
        }
    }
    ...
    extern(C)
    pragma(inline, true)
    int _InterlockedOr()(scope int* value, int mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    byte _InterlockedOr8()(scope byte* value, byte mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    short _InterlockedOr16()(scope short* value, short mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    long _interlockedor64()(scope long* value, long mask) @safe pure nothrow @nogc
    {
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedOr_acq()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedOr_rel()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedOr_nf()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedOr8_acq()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedOr8_rel()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedOr8_nf()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedOr16_acq()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedOr16_rel()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedOr16_nf()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedOr64_acq()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedOr64_rel()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedOr64_nf()(scope long* value, long mask) @safe pure nothrow @nogc
        {
    ...
    version (X86_64)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedOr_np()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedOr8_np()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedOr16_np()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedOr64_np()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedOr64_HLEAcquire()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedOr64_HLERelease()(scope long* value, long mask) @safe pure nothrow @nogc
        {
    ...
    version (X86_64_Or_X86)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedOr_HLEAcquire()(scope int* value, int mask) @safe pure nothrow @nogc
        {
            return interlockedOpHLE!(true, "|", "or")(value, mask);
        }
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedOr_HLERelease()(scope int* value, int mask) @safe pure nothrow @nogc
        {
            return interlockedOpHLE!(false, "|", "or")(value, mask);
        }
    }
    ...
    extern(C)
    pragma(inline, true)
    int _InterlockedXor()(scope int* value, int mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    byte _InterlockedXor8()(scope byte* value, byte mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    short _InterlockedXor16()(scope short* value, short mask) @safe pure nothrow @nogc
    {
    ...
    extern(C)
    pragma(inline, true)
    long _interlockedxor64()(scope long* value, long mask) @safe pure nothrow @nogc
    {
    ...
    version (AArch64_Or_ARM)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedXor_acq()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedXor_rel()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedXor_nf()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedXor8_acq()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedXor8_rel()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedXor8_nf()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedXor16_acq()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedXor16_rel()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedXor16_nf()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedXor64_acq()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedXor64_rel()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedXor64_nf()(scope long* value, long mask) @safe pure nothrow @nogc
        {
    ...
    version (X86_64)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedXor_np()(scope int* value, int mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        byte _InterlockedXor8_np()(scope byte* value, byte mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        short _InterlockedXor16_np()(scope short* value, short mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedXor64_np()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedXor64_HLEAcquire()(scope long* value, long mask) @safe pure nothrow @nogc
        {
        ...
        extern(C)
        pragma(inline, true)
        long _InterlockedXor64_HLERelease()(scope long* value, long mask) @safe pure nothrow @nogc
        {
    ...
    version (X86_64_Or_X86)
    {
        extern(C)
        pragma(inline, true)
        int _InterlockedXor_HLEAcquire()(scope int* value, int mask) @safe pure nothrow @nogc
        {
            return interlockedOpHLE!(true, "^", "xor")(value, mask);
        }
        ...
        extern(C)
        pragma(inline, true)
        int _InterlockedXor_HLERelease()(scope int* value, int mask) @safe pure nothrow @nogc
        {
            return interlockedOpHLE!(false, "^", "xor")(value, mask);
        }
    }
    ...
    extern(C)
    pragma(inline, true)
    private T interlockedAdd(MemoryOrder order = MemoryOrder.seq, T)(scope T* address, T value)
    @safe pure nothrow @nogc
    {
        if (__ctfe)
        {
    ...
    )(scope T* address, T bitIndex) @system pure nothrow @nogc
    {
        static ubyte bitTestOpViaSoftware(scope T* address, T bitIndex)
        {
            ...
            scope T* integer = address + (bitIndex >> bitShift);
        ...
        private T interlockedExchangeAddHLE(bool acquire, T)(scope T* address, scope T value) @trusted
        {
            ...
            else
            {
                ...
                else version (GNU)
                {
                    ...
                    return mixin(add)(cast(shared) address, value, hleOrder);
                }
                else version (InlineAsm_X86_64_Or_X86)
                {
                    import core.bitop : bsr;
        ...
        @trusted
        {
            ...
            else
            {
                ...
                else version (GNU)
                {
                    ...
                    T value = mixin(load)(cast(shared) address, MemoryOrder.raw);
        ...
        @trusted
        {
            ...
            else
            {
                ...
                else version (GNU)
                {
                    ...
                    return cast(T) mixin(exchange)(cast(shared) address, cast(Int) value, hleOrder);
                }
                else version (InlineAsm_X86_64_Or_X86)
                {
                    import core.bitop : bsr;
    ...
    extern(C)
    pragma(inline, true)
    private T interlockedExchange(MemoryOrder order = MemoryOrder.seq, T)(scope T* address, scope T value)
    @trusted
    {
        if (__ctfe)
        {
        ...
        else
        {
            static if (order == MemoryOrder.acq)
            {
                ...
                version (LDC)
                {
                    ...
                    T result = llvm_atomic_rmw_xchg!(T)(cast(shared) address, value, _ordering!order);
                }
                else version (GNU)
                {
                    import core.internal.traits : AliasSeq;
                    ...
                    T result = cast(T) mixin(exchange)(cast(shared) address, cast(Int) value, order);
                }
                else
                {
    ...
    ) @system pure nothrow @nogc
    {
        ...
        if (__ctfe)
        {
            if (address[0] == expectedValue[0] && address[1] == expectedValue[1])
            {
                address[lo] = valueToSetLow;
                address[hi] = valueToSetHigh;

                return 1;
            }

            expectedValue[0] = address[0];
            expectedValue[1] = address[1];
    ...
    ) @trusted pure nothrow @nogc
    {
        ...
        else
        {
            ...
            version (LDC)
            {
                ...
                T value = mixin(name)(cast(shared) address, operand, _ordering!order);
            }
            else version (GNU)
            {
                ...
                T value = mixin(name)(cast(shared) address, operand, order);
            }
            else
            {
                import core.internal.atomic : atomicCompareExchangeWeak, atomicLoad;
    ...
    version (X86_64_Or_X86)
    {
        ...
        void __svm_invlpga()(scope void* Vaddr, int as_id) @system nothrow @nogc
        {
            ...
            else version (GNU)
            {
                asm @system nothrow @nogc
                {
                    /* The order of the operands is not reversed in AT&T syntax for this instruction. */
                    "invlpga %0, %1" : : "a" (Vaddr), "c" (as_id) : "memory";
                }
            }
            else version (D_InlineAsm_X86_64)
            {
