...
alias PFILE_INFO_2 = FILE_INFO_2*, LPFILE_INFO_2 = FILE_INFO_2*;
...
alias PFILE_INFO_3 = FILE_INFO_3*, LPFILE_INFO_3 = FILE_INFO_3*;

struct SHARE_INFO_0 {
    LPTSTR shi0_netname;
}
alias PSHARE_INFO_0 = SHARE_INFO_0*, LPSHARE_INFO_0 = SHARE_INFO_0*;
...
alias PSHARE_INFO_1 = SHARE_INFO_1*, LPSHARE_INFO_1 = SHARE_INFO_1*;
...
alias PSHARE_INFO_2 = SHARE_INFO_2*, LPSHARE_INFO_2 = SHARE_INFO_2*;
...
alias PSHARE_INFO_502 = SHARE_INFO_502*, LPSHARE_INFO_502 = SHARE_INFO_502*;

struct SHARE_INFO_1004 {
    LPTSTR shi1004_remark;
}
alias PSHARE_INFO_1004 = SHARE_INFO_1004*, LPSHARE_INFO_1004 = SHARE_INFO_1004*;

struct SHARE_INFO_1006 {
    DWORD shi1006_max_uses;
}
alias PSHARE_INFO_1006 = SHARE_INFO_1006*, LPSHARE_INFO_1006 = SHARE_INFO_1006*;

struct SHARE_INFO_1501 {
    DWORD shi1501_reserved;
    PSECURITY_DESCRIPTOR shi1501_security_descriptor;
}
alias PSHARE_INFO_1501 = SHARE_INFO_1501*, LPSHARE_INFO_1501 = SHARE_INFO_1501*;

struct SESSION_INFO_0 {
    LPWSTR sesi0_cname;
}
alias PSESSION_INFO_0 = SESSION_INFO_0*, LPSESSION_INFO_0 = SESSION_INFO_0*;
...
alias PSESSION_INFO_1 = SESSION_INFO_1*, LPSESSION_INFO_1 = SESSION_INFO_1*;
...
alias PSESSION_INFO_2 = SESSION_INFO_2*, LPSESSION_INFO_2 = SESSION_INFO_2*;
...
alias PSESSION_INFO_10 = SESSION_INFO_10*, LPSESSION_INFO_10 = SESSION_INFO_10*;
...
alias PSESSION_INFO_502 = SESSION_INFO_502*, LPSESSION_INFO_502 = SESSION_INFO_502*;

struct CONNECTION_INFO_0 {
    DWORD coni0_id;
}
alias PCONNECTION_INFO_0 = CONNECTION_INFO_0*, LPCONNECTION_INFO_0 = CONNECTION_INFO_0*;
...
alias PCONNECTION_INFO_1 = CONNECTION_INFO_1*, LPCONNECTION_INFO_1 = CONNECTION_INFO_1*;
