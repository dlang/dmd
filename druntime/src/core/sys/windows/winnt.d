...
alias VOID = void;
alias CHAR = char, CCHAR = char;
alias WCHAR = wchar;
alias BOOLEAN = bool;
alias FCHAR = byte;
alias UCHAR = ubyte;
alias SHORT = short;
alias LANGID = ushort, FSHORT = ushort;
alias LCID = uint, FLONG = uint, ACCESS_MASK = uint;
alias LONGLONG = long, USN = long;
alias DWORDLONG = ulong, ULONGLONG = ulong;

alias PVOID = void*, LPVOID = void*;
alias PSZ = char*, PCHAR = char*, PCCHAR = char*, LPCH = char*, PCH = char*, LPSTR = char*, PSTR = char*;
alias PWCHAR = wchar*, LPWCH = wchar*, PWCH = wchar*, LPWSTR = wchar*, PWSTR = wchar*;
alias PBOOLEAN = bool*;
alias PUCHAR = ubyte*;
alias PSHORT = short*;
alias PLONG = int*;
alias PLCID = uint*, PACCESS_MASK = uint*;
alias PLONGLONG = long*;
alias PDWORDLONG = ulong*, PULONGLONG = ulong*;

// FIXME(MinGW) for __WIN64
alias PVOID64 = void*;

// const versions
alias PCCH = const(char)*, LPCCH = const(char)*, PCSTR = const(char)*, LPCSTR = const(char)*;
alias LPCWCH = const(wchar)*, PCWCH = const(wchar)*, LPCWSTR = const(wchar)*, PCWSTR = const(wchar)*;

alias PZPSTR = PSTR*;
alias PZPWSTR = PWSTR*;

version (Unicode) {
    alias TCHAR = WCHAR, _TCHAR = WCHAR;
} else {
    alias TCHAR = CHAR, _TCHAR = CHAR;
}
...
alias PSYSTEM_AUDIT_ACE = SYSTEM_AUDIT_ACE *;
...
alias PSECURITY_ATTRIBUTES = SECURITY_ATTRIBUTES*, LPSECURITY_ATTRIBUTES = SECURITY_ATTRIBUTES*;
...
alias PSID_IDENTIFIER_AUTHORITY = SID_IDENTIFIER_AUTHORITY*, LPSID_IDENTIFIER_AUTHORITY = SID_IDENTIFIER_AUTHORITY*;
...
alias PTOKEN_GROUPS = TOKEN_GROUPS*, LPTOKEN_GROUPS = TOKEN_GROUPS*;
...
alias PTOKEN_PRIVILEGES = TOKEN_PRIVILEGES*, LPTOKEN_PRIVILEGES = TOKEN_PRIVILEGES*;
...
alias PSECURITY_DESCRIPTOR = SECURITY_DESCRIPTOR*, PISECURITY_DESCRIPTOR = SECURITY_DESCRIPTOR*;
...
alias PSINGLE_LIST_ENTRY = SINGLE_LIST_ENTRY*, PSLIST_ENTRY = SINGLE_LIST_ENTRY*;
...
alias POSVERSIONINFOEXA = OSVERSIONINFOEXA*, LPOSVERSIONINFOEXA = OSVERSIONINFOEXA*;
...
alias POSVERSIONINFOEXW = OSVERSIONINFOEXW*, LPOSVERSIONINFOEXW = OSVERSIONINFOEXW*;
...
alias PREPARSE_DATA_BUFFER = REPARSE_DATA_BUFFER *;
...
alias PJOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION = JOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION *;
...
extern (Windows) {
    alias PIMAGE_TLS_CALLBACK = void function(PVOID, DWORD, PVOID);

    static if (_WIN32_WINNT >= 0x500) {
        alias PVECTORED_EXCEPTION_HANDLER = LONG function(PEXCEPTION_POINTERS);
...
static if (_WIN32_WINNT >= 0x501) {
    ...
    alias PACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION = ACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION*;
    alias PCACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION = const(ACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION)*;
    ...
    alias PACTIVATION_CONTEXT_DETAILED_INFORMATION = ACTIVATION_CONTEXT_DETAILED_INFORMATION*;
    alias PCACTIVATION_CONTEXT_DETAILED_INFORMATION = const(ACTIVATION_CONTEXT_DETAILED_INFORMATION)*;

    struct ACTIVATION_CONTEXT_QUERY_INDEX {
        ULONG ulAssemblyIndex;
        ULONG ulFileIndexInAssembly;
    }
    alias PACTIVATION_CONTEXT_QUERY_INDEX = ACTIVATION_CONTEXT_QUERY_INDEX*;
    ...
    alias PASSEMBLY_FILE_DETAILED_INFORMATION = ASSEMBLY_FILE_DETAILED_INFORMATION*;
    alias PCASSEMBLY_FILE_DETAILED_INFORMATION = const(ASSEMBLY_FILE_DETAILED_INFORMATION)*;
}
...
alias POSVERSIONINFO = OSVERSIONINFO*, LPOSVERSIONINFO = OSVERSIONINFO*;
alias POSVERSIONINFOEX = OSVERSIONINFOEX*, LPOSVERSIONINFOEX = OSVERSIONINFOEX*;
