...
alias PREPL_INFO_0 = REPL_INFO_0*, LPREPL_INFO_0 = REPL_INFO_0*;

struct REPL_INFO_1000 {
    DWORD rp1000_interval;
}
alias PREPL_INFO_1000 = REPL_INFO_1000*, LPREPL_INFO_1000 = REPL_INFO_1000*;

struct REPL_INFO_1001 {
    DWORD rp1001_pulse;
}
alias PREPL_INFO_1001 = REPL_INFO_1001*, LPREPL_INFO_1001 = REPL_INFO_1001*;

struct REPL_INFO_1002 {
    DWORD rp1002_guardtime;
}
alias PREPL_INFO_1002 = REPL_INFO_1002*, LPREPL_INFO_1002 = REPL_INFO_1002*;

struct REPL_INFO_1003 {
    DWORD rp1003_random;
}
alias PREPL_INFO_1003 = REPL_INFO_1003*, LPREPL_INFO_1003 = REPL_INFO_1003*;

struct REPL_EDIR_INFO_0 {
    LPWSTR rped0_dirname;
}
alias PREPL_EDIR_INFO_0 = REPL_EDIR_INFO_0*, LPREPL_EDIR_INFO_0 = REPL_EDIR_INFO_0*;
...
alias PREPL_EDIR_INFO_1 = REPL_EDIR_INFO_1*, LPREPL_EDIR_INFO_1 = REPL_EDIR_INFO_1*;
...
alias PREPL_EDIR_INFO_2 = REPL_EDIR_INFO_2*, LPREPL_EDIR_INFO_2 = REPL_EDIR_INFO_2*;

struct REPL_EDIR_INFO_1000 {
    DWORD rped1000_integrity;
}
alias PREPL_EDIR_INFO_1000 = REPL_EDIR_INFO_1000*, LPREPL_EDIR_INFO_1000 = REPL_EDIR_INFO_1000*;

struct REPL_EDIR_INFO_1001 {
    DWORD rped1001_extent;
}
alias PREPL_EDIR_INFO_1001 = REPL_EDIR_INFO_1001*, LPREPL_EDIR_INFO_1001 = REPL_EDIR_INFO_1001*;

struct REPL_IDIR_INFO_0 {
    LPWSTR rpid0_dirname;
}
alias PREPL_IDIR_INFO_0 = REPL_IDIR_INFO_0*, LPREPL_IDIR_INFO_0 = REPL_IDIR_INFO_0*;
...
alias PREPL_IDIR_INFO_1 = REPL_IDIR_INFO_1*, LPREPL_IDIR_INFO_1 = REPL_IDIR_INFO_1*;
