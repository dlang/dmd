...
alias PWKSTA_INFO_100 = WKSTA_INFO_100*, LPWKSTA_INFO_100 = WKSTA_INFO_100*;
...
alias PWKSTA_INFO_101 = WKSTA_INFO_101*, LPWKSTA_INFO_101 = WKSTA_INFO_101*;
...
alias PWKSTA_INFO_102 = WKSTA_INFO_102*, LPWKSTA_INFO_102 = WKSTA_INFO_102*;
...
alias PWKSTA_INFO_302 = WKSTA_INFO_302*, LPWKSTA_INFO_302 = WKSTA_INFO_302*;
...
alias PWKSTA_INFO_402 = WKSTA_INFO_402*, LPWKSTA_INFO_402 = WKSTA_INFO_402*;
...
alias PWKSTA_INFO_502 = WKSTA_INFO_502*, LPWKSTA_INFO_502 = WKSTA_INFO_502*;

struct WKSTA_INFO_1010 {
    DWORD wki1010_char_wait;
}
alias PWKSTA_INFO_1010 = WKSTA_INFO_1010*, LPWKSTA_INFO_1010 = WKSTA_INFO_1010*;

struct WKSTA_INFO_1011 {
    DWORD wki1011_collection_time;
}
alias PWKSTA_INFO_1011 = WKSTA_INFO_1011*, LPWKSTA_INFO_1011 = WKSTA_INFO_1011*;

struct WKSTA_INFO_1012 {
    DWORD wki1012_maximum_collection_count;
}
alias PWKSTA_INFO_1012 = WKSTA_INFO_1012*, LPWKSTA_INFO_1012 = WKSTA_INFO_1012*;

struct WKSTA_INFO_1027 {
    DWORD wki1027_errlog_sz;
}
alias PWKSTA_INFO_1027 = WKSTA_INFO_1027*, LPWKSTA_INFO_1027 = WKSTA_INFO_1027*;

struct WKSTA_INFO_1028 {
    DWORD wki1028_print_buf_time;
}
alias PWKSTA_INFO_1028 = WKSTA_INFO_1028*, LPWKSTA_INFO_1028 = WKSTA_INFO_1028*;

struct WKSTA_INFO_1032 {
    DWORD wki1032_wrk_heuristics;
}
alias PWKSTA_INFO_1032 = WKSTA_INFO_1032*, LPWKSTA_INFO_1032 = WKSTA_INFO_1032*;

struct WKSTA_INFO_1013 {
    DWORD wki1013_keep_conn;
}
alias PWKSTA_INFO_1013 = WKSTA_INFO_1013*, LPWKSTA_INFO_1013 = WKSTA_INFO_1013*;

struct WKSTA_INFO_1018 {
    DWORD wki1018_sess_timeout;
}
alias PWKSTA_INFO_1018 = WKSTA_INFO_1018*, LPWKSTA_INFO_1018 = WKSTA_INFO_1018*;

struct WKSTA_INFO_1023 {
    DWORD wki1023_siz_char_buf;
}
alias PWKSTA_INFO_1023 = WKSTA_INFO_1023*, LPWKSTA_INFO_1023 = WKSTA_INFO_1023*;

struct WKSTA_INFO_1033 {
    DWORD wki1033_max_threads;
}
alias PWKSTA_INFO_1033 = WKSTA_INFO_1033*, LPWKSTA_INFO_1033 = WKSTA_INFO_1033*;

struct WKSTA_INFO_1041 {
    DWORD wki1041_lock_quota;
}
alias PWKSTA_INFO_1041 = WKSTA_INFO_1041*, LPWKSTA_INFO_1041 = WKSTA_INFO_1041*;

struct WKSTA_INFO_1042 {
    DWORD wki1042_lock_increment;
}
alias PWKSTA_INFO_1042 = WKSTA_INFO_1042*, LPWKSTA_INFO_1042 = WKSTA_INFO_1042*;

struct WKSTA_INFO_1043 {
    DWORD wki1043_lock_maximum;
}
alias PWKSTA_INFO_1043 = WKSTA_INFO_1043*, LPWKSTA_INFO_1043 = WKSTA_INFO_1043*;

struct WKSTA_INFO_1044 {
    DWORD wki1044_pipe_increment;
}
alias PWKSTA_INFO_1044 = WKSTA_INFO_1044*, LPWKSTA_INFO_1044 = WKSTA_INFO_1044*;

struct WKSTA_INFO_1045 {
    DWORD wki1045_pipe_maximum;
}
alias PWKSTA_INFO_1045 = WKSTA_INFO_1045*, LPWKSTA_INFO_1045 = WKSTA_INFO_1045*;

struct WKSTA_INFO_1046 {
    DWORD wki1046_dormant_file_limit;
}
alias PWKSTA_INFO_1046 = WKSTA_INFO_1046*, LPWKSTA_INFO_1046 = WKSTA_INFO_1046*;

struct WKSTA_INFO_1047 {
    DWORD wki1047_cache_file_timeout;
}
alias PWKSTA_INFO_1047 = WKSTA_INFO_1047*, LPWKSTA_INFO_1047 = WKSTA_INFO_1047*;

struct WKSTA_INFO_1048 {
    BOOL wki1048_use_opportunistic_locking;
}
alias PWKSTA_INFO_1048 = WKSTA_INFO_1048*, LPWKSTA_INFO_1048 = WKSTA_INFO_1048*;

struct WKSTA_INFO_1049 {
    BOOL wki1049_use_unlock_behind;
}
alias PWKSTA_INFO_1049 = WKSTA_INFO_1049*, LPWKSTA_INFO_1049 = WKSTA_INFO_1049*;

struct WKSTA_INFO_1050 {
    BOOL wki1050_use_close_behind;
}
alias PWKSTA_INFO_1050 = WKSTA_INFO_1050*, LPWKSTA_INFO_1050 = WKSTA_INFO_1050*;

struct WKSTA_INFO_1051 {
    BOOL wki1051_buf_named_pipes;
}
alias PWKSTA_INFO_1051 = WKSTA_INFO_1051*, LPWKSTA_INFO_1051 = WKSTA_INFO_1051*;

struct WKSTA_INFO_1052 {
    BOOL wki1052_use_lock_read_unlock;
}
alias PWKSTA_INFO_1052 = WKSTA_INFO_1052*, LPWKSTA_INFO_1052 = WKSTA_INFO_1052*;

struct WKSTA_INFO_1053 {
    BOOL wki1053_utilize_nt_caching;
}
alias PWKSTA_INFO_1053 = WKSTA_INFO_1053*, LPWKSTA_INFO_1053 = WKSTA_INFO_1053*;

struct WKSTA_INFO_1054 {
    BOOL wki1054_use_raw_read;
}
alias PWKSTA_INFO_1054 = WKSTA_INFO_1054*, LPWKSTA_INFO_1054 = WKSTA_INFO_1054*;

struct WKSTA_INFO_1055 {
    BOOL wki1055_use_raw_write;
}
alias PWKSTA_INFO_1055 = WKSTA_INFO_1055*, LPWKSTA_INFO_1055 = WKSTA_INFO_1055*;

struct WKSTA_INFO_1056 {
    BOOL wki1056_use_write_raw_data;
}
alias PWKSTA_INFO_1056 = WKSTA_INFO_1056*, LPWKSTA_INFO_1056 = WKSTA_INFO_1056*;

struct WKSTA_INFO_1057 {
    BOOL wki1057_use_encryption;
}
alias PWKSTA_INFO_1057 = WKSTA_INFO_1057*, LPWKSTA_INFO_1057 = WKSTA_INFO_1057*;

struct WKSTA_INFO_1058 {
    BOOL wki1058_buf_files_deny_write;
}
alias PWKSTA_INFO_1058 = WKSTA_INFO_1058*, LPWKSTA_INFO_1058 = WKSTA_INFO_1058*;

struct WKSTA_INFO_1059 {
    BOOL wki1059_buf_read_only_files;
}
alias PWKSTA_INFO_1059 = WKSTA_INFO_1059*, LPWKSTA_INFO_1059 = WKSTA_INFO_1059*;

struct WKSTA_INFO_1060 {
    BOOL wki1060_force_core_create_mode;
}
alias PWKSTA_INFO_1060 = WKSTA_INFO_1060*, LPWKSTA_INFO_1060 = WKSTA_INFO_1060*;

struct WKSTA_INFO_1061 {
    BOOL wki1061_use_512_byte_max_transfer;
}
alias PWKSTA_INFO_1061 = WKSTA_INFO_1061*, LPWKSTA_INFO_1061 = WKSTA_INFO_1061*;

struct WKSTA_INFO_1062 {
    DWORD wki1062_read_ahead_throughput;
}
alias PWKSTA_INFO_1062 = WKSTA_INFO_1062*, LPWKSTA_INFO_1062 = WKSTA_INFO_1062*;

struct WKSTA_USER_INFO_0 {
    LPWSTR wkui0_username;
}
alias PWKSTA_USER_INFO_0 = WKSTA_USER_INFO_0*, LPWKSTA_USER_INFO_0 = WKSTA_USER_INFO_0*;
...
alias PWKSTA_USER_INFO_1 = WKSTA_USER_INFO_1*, LPWKSTA_USER_INFO_1 = WKSTA_USER_INFO_1*;

struct WKSTA_USER_INFO_1101 {
    LPWSTR wkui1101_oth_domains;
}
alias PWKSTA_USER_INFO_1101 = WKSTA_USER_INFO_1101*, LPWKSTA_USER_INFO_1101 = WKSTA_USER_INFO_1101*;
...
alias PWKSTA_TRANSPORT_INFO_0 = WKSTA_TRANSPORT_INFO_0*, LPWKSTA_TRANSPORT_INFO_0 = WKSTA_TRANSPORT_INFO_0*;
