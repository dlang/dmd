...
alias PUSER_INFO_0 = USER_INFO_0*, LPUSER_INFO_0 = USER_INFO_0*;
...
alias PUSER_INFO_1 = USER_INFO_1*, LPUSER_INFO_1 = USER_INFO_1*;
...
alias PUSER_INFO_2 = USER_INFO_2*, LPUSER_INFO_2 = USER_INFO_2*;
...
alias PUSER_INFO_3 = USER_INFO_3*, LPUSER_INFO_3 = USER_INFO_3*;
...
alias PUSER_INFO_10 = USER_INFO_10*, LPUSER_INFO_10 = USER_INFO_10*;
...
alias PUSER_INFO_11 = USER_INFO_11*, LPUSER_INFO_11 = USER_INFO_11*;
...
alias PUSER_INFO_20 = USER_INFO_20*, LPUSER_INFO_20 = USER_INFO_20*;

struct USER_INFO_21 {
    BYTE[ENCRYPTED_PWLEN] usri21_password;
}
alias PUSER_INFO_21 = USER_INFO_21*, LPUSER_INFO_21 = USER_INFO_21*;
...
alias PUSER_INFO_22 = USER_INFO_22*, LPUSER_INFO_22 = USER_INFO_22*;

struct USER_INFO_1003{
    LPWSTR usri1003_password;
}
alias PUSER_INFO_1003 = USER_INFO_1003*, LPUSER_INFO_1003 = USER_INFO_1003*;

struct USER_INFO_1005{
    DWORD usri1005_priv;
}
alias PUSER_INFO_1005 = USER_INFO_1005*, LPUSER_INFO_1005 = USER_INFO_1005*;

struct USER_INFO_1006{
    LPWSTR usri1006_home_dir;
}
alias PUSER_INFO_1006 = USER_INFO_1006*, LPUSER_INFO_1006 = USER_INFO_1006*;

struct USER_INFO_1007{
    LPWSTR usri1007_comment;
}
alias PUSER_INFO_1007 = USER_INFO_1007*, LPUSER_INFO_1007 = USER_INFO_1007*;

struct USER_INFO_1008{
    DWORD usri1008_flags;
}
alias PUSER_INFO_1008 = USER_INFO_1008*, LPUSER_INFO_1008 = USER_INFO_1008*;

struct USER_INFO_1009{
    LPWSTR usri1009_script_path;
}
alias PUSER_INFO_1009 = USER_INFO_1009*, LPUSER_INFO_1009 = USER_INFO_1009*;

struct USER_INFO_1010{
    DWORD usri1010_auth_flags;
}
alias PUSER_INFO_1010 = USER_INFO_1010*, LPUSER_INFO_1010 = USER_INFO_1010*;

struct USER_INFO_1011{
    LPWSTR usri1011_full_name;
}
alias PUSER_INFO_1011 = USER_INFO_1011*, LPUSER_INFO_1011 = USER_INFO_1011*;

struct USER_INFO_1012{
    LPWSTR usri1012_usr_comment;
}
alias PUSER_INFO_1012 = USER_INFO_1012*, LPUSER_INFO_1012 = USER_INFO_1012*;

struct USER_INFO_1013{
    LPWSTR usri1013_parms;
}
alias PUSER_INFO_1013 = USER_INFO_1013*, LPUSER_INFO_1013 = USER_INFO_1013*;

struct USER_INFO_1014{
    LPWSTR usri1014_workstations;
}
alias PUSER_INFO_1014 = USER_INFO_1014*, LPUSER_INFO_1014 = USER_INFO_1014*;

struct USER_INFO_1017{
    DWORD usri1017_acct_expires;
}
alias PUSER_INFO_1017 = USER_INFO_1017*, LPUSER_INFO_1017 = USER_INFO_1017*;

struct USER_INFO_1018{
    DWORD usri1018_max_storage;
}
alias PUSER_INFO_1018 = USER_INFO_1018*, LPUSER_INFO_1018 = USER_INFO_1018*;

struct USER_INFO_1020{
    DWORD usri1020_units_per_week;
    PBYTE usri1020_logon_hours;
}
alias PUSER_INFO_1020 = USER_INFO_1020*, LPUSER_INFO_1020 = USER_INFO_1020*;

struct USER_INFO_1023{
    LPWSTR usri1023_logon_server;
}
alias PUSER_INFO_1023 = USER_INFO_1023*, LPUSER_INFO_1023 = USER_INFO_1023*;

struct USER_INFO_1024{
    DWORD usri1024_country_code;
}
alias PUSER_INFO_1024 = USER_INFO_1024*, LPUSER_INFO_1024 = USER_INFO_1024*;

struct USER_INFO_1025{
    DWORD usri1025_code_page;
}
alias PUSER_INFO_1025 = USER_INFO_1025*, LPUSER_INFO_1025 = USER_INFO_1025*;

struct USER_INFO_1051{
    DWORD usri1051_primary_group_id;
}
alias PUSER_INFO_1051 = USER_INFO_1051*, LPUSER_INFO_1051 = USER_INFO_1051*;

struct USER_INFO_1052{
    LPWSTR usri1052_profile;
}
alias PUSER_INFO_1052 = USER_INFO_1052*, LPUSER_INFO_1052 = USER_INFO_1052*;

struct USER_INFO_1053{
    LPWSTR usri1053_home_dir_drive;
}
alias PUSER_INFO_1053 = USER_INFO_1053*, LPUSER_INFO_1053 = USER_INFO_1053*;
...
alias PUSER_MODALS_INFO_0 = USER_MODALS_INFO_0*, LPUSER_MODALS_INFO_0 = USER_MODALS_INFO_0*;

struct USER_MODALS_INFO_1{
    DWORD usrmod1_role;
    LPWSTR usrmod1_primary;
}
alias PUSER_MODALS_INFO_1 = USER_MODALS_INFO_1*, LPUSER_MODALS_INFO_1 = USER_MODALS_INFO_1*;

struct USER_MODALS_INFO_2{
    LPWSTR usrmod2_domain_name;
    PSID usrmod2_domain_id;
}
alias PUSER_MODALS_INFO_2 = USER_MODALS_INFO_2*, LPUSER_MODALS_INFO_2 = USER_MODALS_INFO_2*;
...
alias PUSER_MODALS_INFO_3 = USER_MODALS_INFO_3*, LPUSER_MODALS_INFO_3 = USER_MODALS_INFO_3*;

struct USER_MODALS_INFO_1001{
    DWORD usrmod1001_min_passwd_len;
}
alias PUSER_MODALS_INFO_1001 = USER_MODALS_INFO_1001*, LPUSER_MODALS_INFO_1001 = USER_MODALS_INFO_1001*;

struct USER_MODALS_INFO_1002{
    DWORD usrmod1002_max_passwd_age;
}
alias PUSER_MODALS_INFO_1002 = USER_MODALS_INFO_1002*, LPUSER_MODALS_INFO_1002 = USER_MODALS_INFO_1002*;

struct USER_MODALS_INFO_1003{
    DWORD usrmod1003_min_passwd_age;
}
alias PUSER_MODALS_INFO_1003 = USER_MODALS_INFO_1003*, LPUSER_MODALS_INFO_1003 = USER_MODALS_INFO_1003*;

struct USER_MODALS_INFO_1004{
    DWORD usrmod1004_force_logoff;
}
alias PUSER_MODALS_INFO_1004 = USER_MODALS_INFO_1004*, LPUSER_MODALS_INFO_1004 = USER_MODALS_INFO_1004*;

struct USER_MODALS_INFO_1005{
    DWORD usrmod1005_password_hist_len;
}
alias PUSER_MODALS_INFO_1005 = USER_MODALS_INFO_1005*, LPUSER_MODALS_INFO_1005 = USER_MODALS_INFO_1005*;

struct USER_MODALS_INFO_1006{
    DWORD usrmod1006_role;
}
alias PUSER_MODALS_INFO_1006 = USER_MODALS_INFO_1006*, LPUSER_MODALS_INFO_1006 = USER_MODALS_INFO_1006*;

struct USER_MODALS_INFO_1007{
    LPWSTR usrmod1007_primary;
}
alias PUSER_MODALS_INFO_1007 = USER_MODALS_INFO_1007*, LPUSER_MODALS_INFO_1007 = USER_MODALS_INFO_1007*;

struct GROUP_INFO_0{
    LPWSTR grpi0_name;
}
alias PGROUP_INFO_0 = GROUP_INFO_0*, LPGROUP_INFO_0 = GROUP_INFO_0*;

struct GROUP_INFO_1{
    LPWSTR grpi1_name;
    LPWSTR grpi1_comment;
}
alias PGROUP_INFO_1 = GROUP_INFO_1*, LPGROUP_INFO_1 = GROUP_INFO_1*;
...
alias PGROUP_INFO_1002 = GROUP_INFO_1002*, LPGROUP_INFO_1002 = GROUP_INFO_1002*;

struct GROUP_INFO_1005{
    DWORD grpi1005_attributes;
}
alias PGROUP_INFO_1005 = GROUP_INFO_1005*, LPGROUP_INFO_1005 = GROUP_INFO_1005*;

struct GROUP_USERS_INFO_0{
    LPWSTR grui0_name;
}
alias PGROUP_USERS_INFO_0 = GROUP_USERS_INFO_0*, LPGROUP_USERS_INFO_0 = GROUP_USERS_INFO_0*;

struct GROUP_USERS_INFO_1{
    LPWSTR grui1_name;
    DWORD grui1_attributes;
}
alias PGROUP_USERS_INFO_1 = GROUP_USERS_INFO_1*, LPGROUP_USERS_INFO_1 = GROUP_USERS_INFO_1*;

struct LOCALGROUP_INFO_0{
    LPWSTR lgrpi0_name;
}
alias PLOCALGROUP_INFO_0 = LOCALGROUP_INFO_0*, LPLOCALGROUP_INFO_0 = LOCALGROUP_INFO_0*;

struct LOCALGROUP_INFO_1{
    LPWSTR lgrpi1_name;
    LPWSTR lgrpi1_comment;
}
alias PLOCALGROUP_INFO_1 = LOCALGROUP_INFO_1*, LPLOCALGROUP_INFO_1 = LOCALGROUP_INFO_1*;

struct LOCALGROUP_INFO_1002{
    LPWSTR lgrpi1002_comment;
}
alias PLOCALGROUP_INFO_1002 = LOCALGROUP_INFO_1002*, LPLOCALGROUP_INFO_1002 = LOCALGROUP_INFO_1002*;
...
alias PLOCALGROUP_MEMBERS_INFO_1 = LOCALGROUP_MEMBERS_INFO_1*, LPLOCALGROUP_MEMBERS_INFO_1 = LOCALGROUP_MEMBERS_INFO_1*;
...
alias PLOCALGROUP_MEMBERS_INFO_2 = LOCALGROUP_MEMBERS_INFO_2*, LPLOCALGROUP_MEMBERS_INFO_2 = LOCALGROUP_MEMBERS_INFO_2*;

struct LOCALGROUP_MEMBERS_INFO_3{
    LPWSTR lgrmi3_domainandname;
}
alias PLOCALGROUP_MEMBERS_INFO_3 = LOCALGROUP_MEMBERS_INFO_3*, LPLOCALGROUP_MEMBERS_INFO_3 = LOCALGROUP_MEMBERS_INFO_3*;

struct LOCALGROUP_USERS_INFO_0{
    LPWSTR lgrui0_name;
}
alias PLOCALGROUP_USERS_INFO_0 = LOCALGROUP_USERS_INFO_0*, LPLOCALGROUP_USERS_INFO_0 = LOCALGROUP_USERS_INFO_0*;
...
alias PACCESS_INFO_0 = ACCESS_INFO_0*, LPACCESS_INFO_0 = ACCESS_INFO_0*;
...
alias PACCESS_INFO_1 = ACCESS_INFO_1*, LPACCESS_INFO_1 = ACCESS_INFO_1*;

struct ACCESS_INFO_1002{
    DWORD acc1002_attr;
}
alias PACCESS_INFO_1002 = ACCESS_INFO_1002*, LPACCESS_INFO_1002 = ACCESS_INFO_1002*;

struct ACCESS_LIST{
    LPTSTR acl_ugname;
    DWORD acl_access;
}
alias PACCESS_LIST = ACCESS_LIST*, LPACCESS_LIST = ACCESS_LIST*;
