...
alias avxCases = AliasSeq!(
    ...
    Code!(uint, 16 / uint.sizeof)([
        /* push   rax                     */ 0x50,
        /* mov    DWORD PTR [rsp],edi     */ 0x89, 0x3c, 0x24,
        /* vbroadcastss xmm0,DWORD PTR [rsp] */ 0xc4, 0xe2, 0x79, 0x18, 0x04, 0x24,
        /* pop    rcx                     */ 0x59,
        /* ret                            */ 0xc3,
    ]),
    Code!(uint*, 16 / uint.sizeof)([
    ...
    Code!(uint, 32 / uint.sizeof)([
        /* push   rax                     */ 0x50,
        /* mov    DWORD PTR [rsp],edi     */ 0x89, 0x3c, 0x24,
        /* vbroadcastss ymm0,DWORD PTR [rsp] */ 0xc4, 0xe2, 0x7d, 0x18, 0x04, 0x24,
        /* pop    rcx                     */ 0x59,
        /* ret                            */ 0xc3,
    ]),
    Code!(uint*, 32 / uint.sizeof)([
    ...
    Code!(ulong, 16 / ulong.sizeof)([
        /* push   rax                     */ 0x50,
        /* mov    QWORD PTR [rsp],rdi     */ 0x48, 0x89, 0x3c, 0x24,
        /* vmovddup xmm0,QWORD PTR [rsp]  */ 0xc5, 0xfb, 0x12, 0x04, 0x24,
        /* pop    rcx                     */ 0x59,
        /* ret                            */ 0xc3,
    ]),
    Code!(ulong*, 16 / ulong.sizeof)([
        /* push   rax                     */ 0x50,
        /* vmovddup xmm0,QWORD PTR [rdi]  */ 0xc5, 0xfb, 0x12, 0x07,
        /* pop    rcx                     */ 0x59,
        /* ret                            */ 0xc3,
    ]),
    Code!(ulong, 32 / ulong.sizeof)([
        /* push   rax                     */ 0x50,
        /* mov    QWORD PTR [rsp],rdi     */ 0x48, 0x89, 0x3c, 0x24,
        /* vbroadcastsd ymm0,QWORD PTR [rsp] */ 0xc4, 0xe2, 0x7d, 0x19, 0x04, 0x24,
        /* pop    rcx                     */ 0x59,
        /* ret                            */ 0xc3,
        /* add    BYTE PTR [rax],al       */ 0x00, 0x00,
    ]),
    ...
    Code!(float, 16 / float.sizeof)([
        /* push   rax                     */ 0x50,
        /* movss  DWORD PTR [rsp],xmm0    */ 0xf3, 0x0f, 0x11, 0x04, 0x24,
        /* vbroadcastss xmm0,DWORD PTR [rsp] */ 0xc4, 0xe2, 0x79, 0x18, 0x04, 0x24,
        /* pop    rcx                     */ 0x59,
        /* ret                            */ 0xc3,
    ]),
    ...
    Code!(double, 32 / double.sizeof)([
        /* push   rax                     */ 0x50,
        /* movsd  QWORD PTR [rsp],xmm0    */ 0xf2, 0x0f, 0x11, 0x04, 0x24,
        /* vbroadcastsd ymm0,QWORD PTR [rsp] */ 0xc4, 0xe2, 0x7d, 0x19, 0x04, 0x24,
        /* pop    rcx                     */ 0x59,
        /* ret                            */ 0xc3,
    ]),
