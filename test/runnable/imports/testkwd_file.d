...
enum thatFunc3 = `_D7imports7testkwd14getCalleeFunc3FiAyaZQe`;

string getCalleeFile() { return __FILE__; }
ulong  getCalleeLine() { return __LINE__; }         enum thatLine = 15;
...
string getCalleeFunc3(int x = 1, string s = "hello") { return __MANGLED_FUNCTION__; }
...
string getFuncArgFunc3(string name = __MANGLED_FUNCTION__) { return name; }
...
string getFuncTiargFunc3(string name = __MANGLED_FUNCTION__)() { return name; }
...
template getInstTiargFunc3(string name = __MANGLED_FUNCTION__) { enum getInstTiargFunc3 = name; }
