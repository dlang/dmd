...
TEST_OUTPUT:
---
fail_compilation/disable.d(50): Error: function disable.DisabledOpAssign.opAssign is not callable because
it is annotated with `@disable`
fail_compilation/disable.d(53): Error: function disable.DisabledPostblit.opAssign is not callable because
it is annotated with `@disable`
fail_compilation/disable.d(56): Error: function disable.HasDtor.opAssign is not callable because it is an
otated with `@disable`
fail_compilation/disable.d(60): Error: generated function disable.Nested!(DisabledOpAssign).Nested.opAssi
n is not callable because it is annotated with `@disable`
fail_compilation/disable.d(63): Error: generated function disable.Nested!(DisabledPostblit).Nested.opAssi
n is not callable because it is annotated with `@disable`
