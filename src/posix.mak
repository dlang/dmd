...
FRONT_SRCS=$(addsuffix .d, $(addprefix $D/,access aggregate aliasthis apply argtypes arrayop	\
	...
	json lambdacomp lib libelf libmach link mars mtype nogc nspace objc opover optimize parse permissivevisitor pragmasem sapply templateparamsem	\
...
ifeq (X86,$(TARGET_CPU))
    ...
    TARGET_OBJS = cod1.o cod3.o cod4.o ptrntab.o
else
...
BACK_SRC = \
	...
	$C/cgsched.d $C/cod1.c $C/cod2.d $C/cod3.c $C/cod4.c $C/cod5.d \
