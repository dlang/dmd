...
immutable Keyword[] keywords = [
    Keyword("this", TOKthis), Keyword("super", TOKsuper), Keyword("assert",
    TOKassert), Keyword("null", TOKnull), Keyword("true", TOKtrue),
    Keyword("false", TOKfalse), Keyword("cast", TOKcast), Keyword("new",
    TOKnew), Keyword("delete", TOKdelete), Keyword("throw", TOKthrow),
    Keyword("module", TOKmodule), Keyword("pragma", TOKpragma),
    Keyword("typeof", TOKtypeof), Keyword("typeid", TOKtypeid),
    Keyword("template", TOKtemplate), Keyword("void", TOKvoid), Keyword("byte",
    TOKint8), Keyword("ubyte", TOKuns8), Keyword("short", TOKint16),
    Keyword("ushort", TOKuns16), Keyword("int", TOKint32), Keyword("uint",
    TOKuns32), Keyword("long", TOKint64), Keyword("ulong", TOKuns64),
    Keyword("cent", TOKint128), Keyword("ucent", TOKuns128), Keyword("float",
    TOKfloat32), Keyword("double", TOKfloat64), Keyword("real", TOKfloat80),
    Keyword("bool", TOKbool), Keyword("char", TOKchar), Keyword("wchar",
    TOKwchar), Keyword("dchar", TOKdchar), Keyword("ifloat", TOKimaginary32),
    Keyword("idouble", TOKimaginary64), Keyword("ireal", TOKimaginary80),
    Keyword("cfloat", TOKcomplex32), Keyword("cdouble", TOKcomplex64),
    Keyword("creal", TOKcomplex80), Keyword("delegate", TOKdelegate),
    Keyword("function", TOKfunction), Keyword("is", TOKis), Keyword("if",
    TOKif), Keyword("else", TOKelse), Keyword("while", TOKwhile),
    Keyword("for", TOKfor), Keyword("do", TOKdo), Keyword("switch", TOKswitch),
    Keyword("case", TOKcase), Keyword("default", TOKdefault), Keyword("break",
    TOKbreak), Keyword("continue", TOKcontinue), Keyword("synchronized",
    TOKsynchronized), Keyword("return", TOKreturn), Keyword("goto", TOKgoto),
    Keyword("try", TOKtry), Keyword("catch", TOKcatch), Keyword("finally",
    TOKfinally), Keyword("with", TOKwith), Keyword("asm", TOKasm),
    Keyword("foreach", TOKforeach), Keyword("foreach_reverse",
    TOKforeach_reverse), Keyword("scope", TOKscope), Keyword("struct",
    TOKstruct), Keyword("class", TOKclass), Keyword("interface", TOKinterface),
    Keyword("union", TOKunion), Keyword("enum", TOKenum), Keyword("import",
    TOKimport), Keyword("mixin", TOKmixin), Keyword("static", TOKstatic),
    Keyword("final", TOKfinal), Keyword("const", TOKconst), Keyword("typedef",
    TOKtypedef), Keyword("alias", TOKalias), Keyword("override", TOKoverride),
    Keyword("abstract", TOKabstract), Keyword("volatile", TOKvolatile),
    Keyword("debug", TOKdebug), Keyword("deprecated", TOKdeprecated),
    Keyword("in", TOKin), Keyword("out", TOKout), Keyword("inout", TOKinout),
    Keyword("lazy", TOKlazy), Keyword("auto", TOKauto), Keyword("align",
    TOKalign), Keyword("extern", TOKextern), Keyword("private", TOKprivate),
    Keyword("package", TOKpackage), Keyword("protected", TOKprotected),
    Keyword("public", TOKpublic), Keyword("export", TOKexport), Keyword("body",
    TOKbody), Keyword("invariant", TOKinvariant), Keyword("unittest",
    TOKunittest), Keyword("version", TOKversion), Keyword("__argTypes",
    TOKargTypes), Keyword("__parameters", TOKparameters), Keyword("ref",
    TOKref), Keyword("macro", TOKmacro), Keyword("pure", TOKpure),
    Keyword("nothrow", TOKnothrow), Keyword("__gshared", TOKgshared),
    Keyword("__traits", TOKtraits), Keyword("__vector", TOKvector),
    Keyword("__overloadset", TOKoverloadset), Keyword("__FILE__", TOKfile),
    Keyword("__LINE__", TOKline), Keyword("__MODULE__", TOKmodulestring),
    Keyword("__FUNCTION__", TOKfuncstring), Keyword("__PRETTY_FUNCTION__",
    TOKprettyfunc), Keyword("shared", TOKshared), Keyword("immutable", TOKimmutable),
];
