...
void functionResolve(Match *m, Dsymbol *fd, Type *tthis, Expressions *arguments);
void templateResolve(Match *m, Dsymbol *td, Loc loc, Scope *sc, Objects *tiargs, Type *tthis, Expressions *fargs);
