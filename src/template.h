...
//    void toDocBuffer(OutBuffer *buf);
    ...
    MATCH deduceFunctionTemplateMatch(Loc loc, Scope *sc, Objects *targsi, Expression *ethis, Expressions *fargs, Objects *dedargs);
    FuncDeclaration *deduceFunctionTemplate(Loc loc, Scope *sc, Objects *targsi, Expression *ethis, Expressions *fargs, int flags = 0);
