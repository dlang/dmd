...
MODULES_ROOT=object_
MODULES_BASE=$(addprefix rt/, aaA aApply aApplyR adi alloca arrayassign         \
        arraybyte arraycast arraycat arraydouble arrayfloat arrayint arrayreal	\
        arrayshort cast_ cmath2 cover deh2 dmain2 invariant invariant_	        \
        lifetime llmath memory memset obj qsort switch_ trace)
...
MODULES_UTIL=$(addprefix rt/util/,console ctype hash string utf)
