...
immutable NameId[] namesB = [{"backcong", 0x0224C}, // ALL EQUAL TO
...
immutable NameId[] namesC = [{"Cacute", 0x00106}, // LATIN CAPITAL LETTER C WITH ACUTE
...
immutable NameId[] namesD = [{"dagger", 0x02020}, // DAGGER
...
immutable NameId[] namesE = [{"Eacgr", 0x00388}, // GREEK CAPITAL LETTER EPSILON WITH TONOS
...
immutable NameId[] namesF = [{"fallingdotseq", 0x02252}, // APPROXIMATELY EQUAL TO OR THE IMAGE OF
...
immutable NameId[] namesG = [{"gacute", 0x001F5}, // LATIN SMALL LETTER G WITH ACUTE
...
immutable NameId[] namesH = [{"Hacek", 0x002C7}, // CARON
...
immutable NameId[] namesI = [{"Iacgr", 0x0038A}, // GREEK CAPITAL LETTER IOTA WITH TONOS
...
immutable NameId[] namesJ = [{"Jcirc", 0x00134}, // LATIN CAPITAL LETTER J WITH CIRCUMFLEX
...
immutable NameId[] namesK = [{"Kappa", 0x0039A}, // GREEK CAPITAL LETTER KAPPA
...
immutable NameId[] namesL = [{"lAarr", 0x021DA}, // LEFTWARDS TRIPLE ARROW
...
immutable NameId[] namesM = [{"macr", 0x000AF}, // MACRON
...
immutable NameId[] namesN = [{"nabla", 0x02207}, // NABLA
...
immutable NameId[] namesO = [{"Oacgr", 0x0038C}, // GREEK CAPITAL LETTER OMICRON WITH TONOS
...
immutable NameId[] namesP = [{"par", 0x02225}, // PARALLEL TO
...
immutable NameId[] namesQ = [{"Qfr", 0x1D514}, // MATHEMATICAL FRAKTUR CAPITAL Q
...
immutable NameId[] namesR = [{"rAarr", 0x021DB}, // RIGHTWARDS TRIPLE ARROW
...
immutable NameId[] namesS = [{"Sacute", 0x0015A}, // LATIN CAPITAL LETTER S WITH ACUTE
...
immutable NameId[] namesT = [{"Tab", 0x00009}, // CHARACTER TABULATION
...
immutable NameId[] namesU = [{"Uacgr", 0x0038E}, // GREEK CAPITAL LETTER UPSILON WITH TONOS
...
immutable NameId[] namesV = [{"vangrt", 0x0299C}, // RIGHT ANGLE VARIANT WITH SQUARE
...
immutable NameId[] namesW = [{"Wcirc", 0x00174}, // LATIN CAPITAL LETTER W WITH CIRCUMFLEX
...
immutable NameId[] namesX = [{"xcap", 0x022C2}, // N-ARY INTERSECTION
...
immutable NameId[] namesY = [{"Yacute", 0x000DD}, // LATIN CAPITAL LETTER Y WITH ACUTE
...
immutable NameId[] namesZ = [{"Zacute", 0x00179}, // LATIN CAPITAL LETTER Z WITH ACUTE
