...
{
    {
        auto fp = fopen("ddmd/lexer/id.h","wb");
        if (!fp)
        {
            printf("can't open ddmd/lexer/id.h\n");
            exit(EXIT_FAILURE);
        }
    ...
    {
        auto fp = fopen("ddmd/lexer/id.d","wb");
        if (!fp)
        {
            printf("can't open ddmd/lexer/id.d\n");
            exit(EXIT_FAILURE);
        }

        fprintf(fp, "// File generated by idgen.d\n");
        fprintf(fp, "\n");
        fprintf(fp, "module ddmd.lexer.id;\n");
        fprintf(fp, "\n");
        fprintf(fp, "import ddmd.lexer.identifier, ddmd.lexer.tokens;\n");
        fprintf(fp, "\n");
        fprintf(fp, "struct Id\n");
        fprintf(fp, "{\n");
