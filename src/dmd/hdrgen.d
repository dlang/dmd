...
import core.stdc.string : memcmp, strlen, strncmp;
import dmd.aggregate : AggregateDeclaration;
import dmd.aliasthis : AliasThis;
import dmd.arraytypes : Expressions, Objects, TemplateParameters;
import dmd.attrib : AttribDeclaration, StorageClassDeclaration, DeprecatedDeclaration, LinkDeclaration, CPPMangleDeclaration, ProtDeclaration, AlignDeclaration, AnonDeclaration, PragmaDeclaration, ConditionalDeclaration, StaticForeachDeclaration, CompileDeclaration, UserAttributeDeclaration;
import dmd.complex : creall, cimagl;
import dmd.cond : Condition, DebugCondition, VersionCondition, StaticIfCondition;
import dmd.ctfeexpr : ClassReferenceExp;
import dmd.dclass : ClassDeclaration;
import dmd.declaration : AliasDeclaration, VarDeclaration, STC, STCStorageClass;
import dmd.denum : EnumDeclaration, EnumMember;
// import dmd.dimport : ;
import dmd.dmodule : Module;
import dmd.doc : Import, escapeDdocString;
import dmd.dstruct : StructDeclaration;
import dmd.dsymbol : Dsymbol, Prot, PASS;
import dmd.dtemplate : TemplateParameter, TemplateDeclaration, TemplateInstance, TemplateMixin, TemplateTypeParameter, TemplateThisParameter, TemplateAliasParameter, TemplateValueParameter, TemplateTupleParameter, isType, isExpression, isDsymbol, isTuple, isParameter;
import dmd.dversion : DebugSymbol, VersionSymbol;
import dmd.expression : Expression, IntegerExp, ErrorExp, VoidInitExp, RealExp, ComplexExp, IdentifierExp, DsymbolExp, ThisExp, SuperExp, NullExp, StringExp, ArrayLiteralExp, AssocArrayLiteralExp, StructLiteralExp, TypeExp, ScopeExp, TemplateExp, NewExp, NewAnonClassExp, SymOffExp, VarExp, OverExp, TupleExp, FuncExp, DeclarationExp, TypeidExp, TraitsExp, HaltExp, IsExp, UnaExp, BinExp, CommaExp, CompileExp, ImportExp, AssertExp, DotIdExp, DotTemplateExp, DotVarExp, DotTemplateInstanceExp, DelegateExp, DotTypeExp, CallExp, PtrExp, DeleteExp, CastExp, VectorExp, VectorArrayExp, SliceExp, ArrayLengthExp, IntervalExp, DelegatePtrExp, DelegateFuncptrExp, ArrayExp, DotExp, IndexExp, PostExp, PreExp, RemoveExp, CondExp, DefaultInitExp, AssignExp, stageToCBuffer, WANTvalue;
import dmd.func : FuncDeclaration, FuncLiteralDeclaration, PostBlitDeclaration, DtorDeclaration, StaticCtorDeclaration, StaticDtorDeclaration, InvariantDeclaration, UnitTestDeclaration, NewDeclaration;
import dmd.globals : StorageClass, LINK, CPPMANGLE, global, dinteger_t, uinteger_t, sinteger_t;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.init : Initializer, ExpInitializer, ErrorInitializer, VoidInitializer, StructInitializer, ArrayInitializer, InitKind;
import dmd.mtype : Type, TRUST, TypeFunction, ParameterList, Parameter, Tfunction, Terror, Tenum, TypeEnum, Twchar, Tdchar, Tchar, Tint8, Tint16, Tint32, Tuns8, Tuns32, Tuns16, Tint64, Tuns64, Tbool, Tpointer, Tfloat32, Timaginary32, Tcomplex32, Tfloat80, Timaginary80, Tcomplex80, MODtoBuffer, VarArg, MODFlags, Tident, TypeIdentifier, Ttuple, TypeError, TypeBasic, TypeTraits, TypeVector, TypeSArray, TypeDArray, TypeAArray, TypePointer, TypeReference, TypeDelegate, TypeQualified, TypeInstance, TypeTypeof, TypeReturn, TypeStruct, TypeClass, TypeTuple, TypeSlice, TypeNull, TypeMixin, Ttraits, Tvector, Tsarray, Tarray, Taarray, Treference, Tdelegate, Tinstance, Ttypeof, Treturn, Tstruct, Tclass, Tslice, Tnull, Tmixin, attributesApply;
import dmd.nspace : Nspace;
import dmd.parse : PREC, precedence;
import dmd.root.ctfloat : real_t, CTFloat;
import dmd.root.outbuffer : OutBuffer;
import dmd.root.rootobject : RootObject, DYNCAST;
import dmd.root.string : toDString;
import dmd.statement : Statement, ErrorStatement, ExpStatement, CompileStatement, CompoundStatement, CompoundDeclarationStatement, UnrolledLoopStatement, ScopeStatement, WhileStatement, DoStatement, ForStatement, ForeachStatement, ForeachRangeStatement, StaticForeachStatement, ForwardingStatement, IfStatement, ConditionalStatement, PragmaStatement, StaticAssertStatement, SwitchStatement, CaseStatement, CaseRangeStatement, DefaultStatement, GotoDefaultStatement, GotoCaseStatement, SwitchErrorStatement, ReturnStatement, BreakStatement, ContinueStatement, SynchronizedStatement, WithStatement, TryCatchStatement, TryFinallyStatement, ScopeGuardStatement, ThrowStatement, DebugStatement, GotoStatement, LabelStatement, AsmStatement, ImportStatement, Catch;
