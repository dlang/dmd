...
import dmd.root.array : Array, reverse;
import dmd.root.ctfloat : real_t, CTFloat;
import dmd.root.rmem : Mem, mem;
import dmd.root.rootobject : DYNCAST;
...
import dmd.declaration : Declaration, STC, VarDeclaration;
// import dmd.denum : ;
import dmd.dmodule : Module;
// import dmd.dscope : ;
import dmd.dstruct : StructDeclaration;
import dmd.dsymbol : Dsymbol, PASS, foreachDsymbol;
import dmd.dtemplate : isType, isExpression;
import dmd.errors : error;
import dmd.expression : Expression, StructLiteralExp, StringExp, SymbolExp, FuncExp, DeclarationExp, TypeidExp, ThisExp, IntegerExp, RealExp, ComplexExp, NullExp, NewExp, NegExp, ComExp, NotExp, HaltExp, AssertExp, PostExp, BinExp, BinAssignExp, AddExp, MinExp, CatExp, MulExp, DivExp, ModExp, CmpExp, EqualExp, IdentityExp, InExp, RemoveExp, AssignExp, AddAssignExp, MinAssignExp, CatAssignExp, DivAssignExp, ModAssignExp, MulAssignExp, ShlAssignExp, ShrAssignExp, UshrAssignExp, AndAssignExp, OrAssignExp, XorAssignExp, LogicalExp, XorExp, AndExp, OrExp, ShlExp, ShrExp, UshrExp, CommaExp, CondExp, TypeExp, ScopeExp, DotVarExp, DelegateExp, DotTypeExp, CallExp, AddrExp, PtrExp, DeleteExp, VectorExp, VectorArrayExp, CastExp, ArrayLengthExp, DelegatePtrExp, DelegateFuncptrExp, SliceExp, IndexExp, TupleExp, ArrayLiteralExp, AssocArrayLiteralExp, ObjcClassReferenceExp, SymOffExp, MemorySet, UnaExp, VarExp, DsymbolExp;
import dmd.func : FuncDeclaration, FuncLiteralDeclaration, UnitTestDeclaration;
import dmd.globals : Loc, global, LINK, CHECKENABLE, dinteger_t, CHECKACTION, d_uns64;
import dmd.glue : totym, toEfilenamePtr;
import dmd.id : Id;
// import dmd.init : ;
import dmd.mtype : Type, TypeFunction, Tdelegate, RET, Tstruct, Tsarray, TMAX, VarArg, TY, Tpointer, Tarray, TypeSArray, Terror, Tfloat80, Timaginary80, Tcomplex80, Tcomplex64, Tfloat32, Timaginary32, Tfloat64, Timaginary64, TypeStruct, Tvector, Tfunction, Tclass, Tbool, TypeClass, Tvoid, Taarray, TypeAArray, Tdchar, Tchar, Twchar, TypePointer, Tint64, Tuns64, Tint32, Tuns32, Tint16, Tuns16, Tint8, Tuns8, Tnull, Tcomplex32;
import dmd.objc_glue : objc;
import dmd.s2ir : elem_setLoc;
import dmd.sideeffect : callSideEffectLevel, isTrivialExp;
// import dmd.statement : ;
import dmd.target : target;
import dmd.tocsym : toImport, toInitializer, aaGetSymbol;
import dmd.toctype : Type_toCtype;
import dmd.toir : IRState, intrinsic_op, NotIntrinsic, retStyle, getEthis, OPtoPrec, fixEthis2, setEthis, resolveLengthVar, incUsageElem, setClosureVarOffset;
import dmd.tokens : TOK, Token;
import dmd.toobj : toObjFile;
import dmd.typinf : genTypeInfo;
import dmd.visitor : Visitor;

import dmd.backend.cc : Symbol, config, Blockx, SFLnodebug, SFLartifical, FLdata, STR0size;
import dmd.backend.cdef : EX_WIN64, SCauto, SCparameter, SCshadowreg, targ_size_t, SCcomdat;
import dmd.backend.cgcv ;
import dmd.backend.code : isXMMstore;
import dmd.backend.code_x86;
import dmd.backend.cv4;
import dmd.backend.dt;
import dmd.backend.el : elem, el_una, el_same, el_params, el_ptr, el_param, el_sideeffect, el_copytotmp, el_combine, el_var, el_bin, el_long, el_free, el_tolong, EFLAGS_variadic, el_copytree, el_pair, el_calloc, el_allbits, el_selecte2, el_ctor_dtor;
import dmd.backend.global : symbol_genauto, symbol_add, nteh_declarvars, symbol_calloc, out_readonly_comdat, out_string_literal;
// import dmd.backend.obj : ;
import dmd.backend.oper : OPstrpar, OP128_64, OP64_32, OPind, OPvector, OPadd, OPvar, OTbinary, OPeq, OPscale, OPs32_d, OPd_ld, OPyl2x, OPyl2xp1, OPparam, OPconst, OPvecsto, OPva_start, OPf_d, OPd_f, OPld_d, OPcallns, OPcall, OPucallns, OPucall, OPrelconst, OPstring, OPcomma, OPcond, OPaddr, OPinfo, OPpair, OPmsw, OPmul, OPmemset, OPmin, OPneg, OPxor, OPcom, OPnot, OPoror, OPpostinc, OPpostdec, OPandand, OPdiv, OPmod, OPER, OPlt, OPgt, OPle, OPge, OPeqeq, OPne, rel_integral, OPmemcmp, OPmemcpy, OPaddass, OPminass, OPdivass, OPmodass, OPmulass, OPshlass, OPshrass, OPashrass, OPandass, OPorass, OPxorass, OPand, OPor, OPshl, OPshr, OPashr, OPcolon, OPdctor, OPvecfill, OPbool, OPu8_16, OPs8_16, OP16_8, OPs16_32, OPs16_d, OPu16_32, OP32_16, OPs32_64, OPu32_64, OPu32_d, OPs64_d, OPu64_d, OPd_s16, OPd_u16, OPd_s32, OPd_u32, OPd_s64, OPd_u64, OPld_u64, OPc_r, OPc_i, OPhalt, OPstreq;
import dmd.backend.rtlsym : RTLSYM_MEMSET80, RTLSYM_MEMSET160, RTLSYM_MEMSET128, RTLSYM_MEMSETFLOAT, RTLSYM_MEMSETDOUBLE, RTLSYM_MEMSETSIMD, RTLSYM_MEMSET8, RTLSYM_MEMSET16, RTLSYM_MEMSET32, RTLSYM_MEMSET64, RTLSYM_MEMSET128ii, RTLSYM_MEMSETN, RTLSYM_ARRAYSETCTOR, RTLSYM_ARRAYSETASSIGN, getRtlsym, RTLSYM_NEWTHROW, RTLSYM_NEWCLASS, RTLSYM_NEWITEMT, RTLSYM_NEWITEMIT, RTLSYM_NEWARRAYT, RTLSYM_NEWARRAYIT, RTLSYM_NEWARRAYMTX, RTLSYM_NEWARRAYMITX, RTLSYM_DINVARIANT, RTLSYM_DUNITTEST_MSG, RTLSYM_DASSERT_MSG, RTLSYM_DUNITTEST, RTLSYM_DASSERT, RTLSYM_DUNITTESTP, RTLSYM_DASSERTP, RTLSYM_ARRAYCATNTX, RTLSYM_ARRAYCATT, RTLSYM_ARRAYEQ2, RTLSYM_ARRAYCTOR, RTLSYM_ARRAYASSIGN, RTLSYM_ARRAYCOPY, RTLSYM_ARRAYASSIGN_L, RTLSYM_ARRAYASSIGN_R, RTLSYM_ARRAYAPPENDCD, RTLSYM_ARRAYAPPENDWD, RTLSYM_ARRAYAPPENDT, RTLSYM_ARRAYAPPENDCTX, RTLSYM_DELARRAYT, RTLSYM_CALLFINALIZER, RTLSYM_CALLINTERFACEFINALIZER, RTLSYM_DELCLASS, RTLSYM_DELINTERFACE, RTLSYM_DELMEMORY, RTLSYM_DELSTRUCT, RTLSYM_INTERFACE_CAST, RTLSYM_DYNAMIC_CAST, RTLSYM_ARRAYLITERALTX, RTLSYM_ASSOCARRAYLITERALTX, RTLSYM_DARRAYP, RTLSYM_TRACENEWCLASS, RTLSYM_TRACENEWITEMT, RTLSYM_TRACENEWITEMIT, RTLSYM_TRACENEWARRAYT, RTLSYM_TRACENEWARRAYIT, RTLSYM_TRACENEWARRAYMTX, RTLSYM_TRACENEWARRAYMITX, RTLSYM_TRACEDELCLASS, RTLSYM_TRACECALLFINALIZER, RTLSYM_TRACECALLINTERFACEFINALIZER, RTLSYM_TRACEDELINTERFACE, RTLSYM_TRACEDELARRAYT, RTLSYM_TRACEDELMEMORY, RTLSYM_TRACEDELSTRUCT, RTLSYM_TRACEARRAYLITERALTX, RTLSYM_TRACEASSOCARRAYLITERALTX, RTLSYM_TRACEARRAYCATT, RTLSYM_TRACEARRAYCATNTX, RTLSYM_TRACEARRAYAPPENDCD, RTLSYM_TRACEARRAYAPPENDWD, RTLSYM_TRACEARRAYAPPENDT, RTLSYM_TRACEARRAYAPPENDCTX, RTLSYM_ARRAYSETLENGTHT, RTLSYM_TRACEARRAYSETLENGTHT, RTLSYM_ARRAYSETLENGTHIT, RTLSYM_TRACEARRAYSETLENGTHIT, RTLSYM_ALLOCMEMORY, RTLSYM_TRACEALLOCMEMORY, RTLSYM_C__ASSERT_RTN, RTLSYM_C_ASSERT, RTLSYM_C__ASSERT;
import dmd.backend.symtab : SYMIDX;
import dmd.backend.ty : _tysize, TYnptr, tym_t, tybasic, TYstruct, TYarray, tyrevfunc, TYcfloat, TYllong, tysize, TYsize_t, mTYvolatile, TYdouble, TYldouble, TYfloat, TYvoid, tyaggregate, TYimmutPtr, TYdarray, tyfloating, TYchar, TYshort, TYlong, TYcldouble, TYcdouble, TYucent, TYfloat4, mTYbasic, TYdelegate, tysimd, TYint, TYifloat, TYidouble, TYildouble, TYbool, touns, TYullong, TYuchar, TYuint;
import dmd.backend.type : type, type_fake, type_struct_class, type_size, type_static_array, tstypes, type_setmangle, mTYman_c;
