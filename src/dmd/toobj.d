...
import dmd.arraytypes : FuncDeclarations, ClassDeclarations, Dsymbols;
import dmd.attrib : AttribDeclaration, PragmaDeclaration;
import dmd.dclass : ClassDeclaration, BaseClass, InterfaceDeclaration, ClassFlags;
import dmd.declaration : ObjectNotFound, VarDeclaration, TypeInfoDeclaration, STC;
import dmd.denum : EnumDeclaration;
import dmd.dmodule : Module;
// import dmd.dscope : ;
import dmd.dstruct : StructDeclaration;
import dmd.dsymbol : Dsymbol, PASS, foreachDsymbol;
import dmd.dtemplate : TemplateInstance, TemplateMixin, getDsymbol, isError;
import dmd.errors : fatal;
import dmd.expression : Expression, StringExp;
import dmd.func : FuncDeclaration;
import dmd.globals : d_uns64, Loc, global, LINK;
import dmd.glue : FuncDeclaration_toObjFile, obj_append, bzeroSymbol, obj_includelib, obj_startaddress, obj_linkerdirective;
import dmd.hdrgen : parametersTypeToChars;
import dmd.id : Id;
import dmd.init : ExpInitializer;
import dmd.mtype : Type, Tclass, Terror, SIZE_INVALID, Tsarray, TypeEnum, TypeSArray, TypeFunction;
import dmd.nspace : Nspace;
import dmd.objc_glue : objc;
// import dmd.statement : ;
import dmd.staticassert : StaticAssert;
import dmd.target : target;
import dmd.tocsym : toVtblSymbol, toInitializer, toThunkSymbol;
import dmd.toctype : Type_toCtype;
import dmd.tocvdebug : toDebug;
import dmd.todt : ClassDeclaration_toDt, StructDeclaration_toDt, Type_toDt, Expression_toDt, TypeInfo_toDt, Initializer_toDt;
import dmd.tokens : TOK;
import dmd.traits : getTypePointerBitmap;
import dmd.typinf : genTypeInfo, isSpeculativeType;
import dmd.visitor : Visitor;

import dmd.backend.cc : Symbol, FLdata, SFLweak, enum_SC, config, SFLpublic, dt_t;
import dmd.backend.cdef : SCglobal, SCcomdat, SCextern, OBJ_MACH, SCstatic;
// import dmd.backend.cgcv : ;
// import dmd.backend.code : ;
// import dmd.backend.code_x86 : ;
// import dmd.backend.cv4 : ;
import dmd.backend.dt : DtBuilder, dtallzeros, dt2common, dtpatchoffset;
// import dmd.backend.el : ;
import dmd.backend.global : out_readonly, outdata, symbol_name;
import dmd.backend.obj : objmod;
// import dmd.backend.oper : ;
import dmd.backend.ty : TYnptr, mTYLINK, mTYthread, mTYthreadData;
import dmd.backend.type : mangle_t, type, type_fake, type_setty, type_setmangle, type_alignsize, mTYman_c, mTYman_std, mTYman_pas, mTYman_d, mTYman_cpp;
