...
import dmd.attrib : CPPNamespaceDeclaration, DeprecatedDeclaration, UserAttributeDeclaration, ForwardingAttribDeclaration, StorageClassDeclaration, AttribDeclaration, AnonDeclaration, ProtDeclaration, CompileDeclaration;
import dmd.ast_node : ASTNode;
import dmd.gluelayer : Symbol;
import dmd.dclass : ClassDeclaration, InterfaceDeclaration;
import dmd.declaration : Declaration, ThisDeclaration, TypeInfoDeclaration, TupleDeclaration, AliasDeclaration, OverDeclaration, VarDeclaration, SymbolDeclaration, STC;
import dmd.denum : EnumMember, EnumDeclaration;
import dmd.dimport : Import;
import dmd.dmodule : Module, Package;
import dmd.dversion : VersionSymbol, DebugSymbol;
import dmd.dscope : Scope;
import dmd.dstruct : StructDeclaration, UnionDeclaration;
import dmd.dsymbolsem : getMessage, dsymbolSemantic;
import dmd.dtemplate : TemplateInstance, TemplateDeclaration, TemplateMixin, getDsymbol;
import dmd.errors : verror, vdeprecation, error;
import dmd.expression : Expression, ScopeExp, IntegerExp, ArrayExp, DotTemplateInstanceExp, DotVarExp, CallExp, lastComma;
import dmd.expressionsem : resolveAliasThis, expressionSemantic;
import dmd.func : UnitTestDeclaration, FuncDeclaration, FuncAliasDeclaration, FuncLiteralDeclaration, CtorDeclaration, PostBlitDeclaration, DtorDeclaration, StaticCtorDeclaration, StaticDtorDeclaration, SharedStaticCtorDeclaration, SharedStaticDtorDeclaration, InvariantDeclaration, NewDeclaration;
import dmd.globals : Loc, d_uns64, global, DiagnosticReporting, dinteger_t;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.init : ExpInitializer, VoidInitializer;
import dmd.lexer : Lexer;
import dmd.mtype : Type, TypeTuple, SIZE_INVALID, Tstruct, Tclass, isAggregate, Tfunction;
...
import dmd.statement : LabelDsymbol, WithStatement;
