...
import core.stdc.stdio : sprintf, fprintf, stderr;

import dmd.aggregate : AggregateDeclaration;
import dmd.arrayop : checkNonAssignmentArrayOp;
import dmd.arraytypes : Dsymbols, Statements, Catches, Expressions, Parameters, ScopeStatements, CaseStatements, Objects, ReturnStatements, GotoStatements;
import dmd.blockexit : BE, blockExit;
import dmd.clone : mergeFuncAttrs;
import dmd.cond : DebugCondition;
import dmd.ctorflow : CtorFlow, CSX;
import dmd.dcast : getIntRange, typeCombine, integralPromotions, inferType;
import dmd.dclass : ClassDeclaration;
import dmd.declaration : STC, VarDeclaration, Declaration, AliasDeclaration;
import dmd.denum : EnumDeclaration, EnumMember;
import dmd.dimport : Import;
import dmd.dinterpret : ctfeInterpretForPragmaMsg;
import dmd.dmodule : Module;
import dmd.dscope : Scope, SCOPE;
import dmd.dsymbol : Dsymbol, ScopeDsymbol, WithScopeSymbol;
import dmd.dsymbolsem : dsymbolSemantic;
import dmd.dtemplate : getDsymbol;
import dmd.errors : errorSupplemental, fatal, error;
import dmd.escape : checkReturnEscapeRef, checkThrowEscape;
import dmd.expression : Expression, TupleExp, IntegerExp, VarExp, TemplateExp, ScopeExp, FuncExp, OverExp, DotIdExp, IndexExp, lastComma, ErrorExp, CommaExp, isFuncAddress, WANTvalue, IdentifierExp, Modifiable, SliceExp, ArrayLiteralExp, CastExp, PostExp, CmpExp, AddAssignExp, NotExp, CallExp, expandAliasThisTuples, DeclarationExp, DelegateExp, MinExp, AddExp, EqualExp, PreExp, AssertExp, StringExp, HaltExp, TypeExp, DotTemplateInstanceExp, WANTexpand, ThisExp, valueNoDtor, AddrExp, PtrExp, NewExp;
import dmd.expressionsem : resolveProperties, expressionSemantic, resolveAliasThis, verifyHookExist, checkSharedAccess;
import dmd.func : FuncDeclaration, resolveFuncCall, FuncResolveFlag, FuncLiteralDeclaration, FUNCFLAG;
import dmd.globals : global, Loc, StorageClass, MATCH, LINK, PINLINE, CHECKENABLE, CHECKACTION, uinteger_t, sinteger_t, dinteger_t;
import dmd.gluelayer : asmSemantic;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.init : Initializer, ExpInitializer;
import dmd.intrange : IntRange, SignExtendedNumber;
import dmd.mtype : TypeFunction, Type, Terror, TypeTuple, Parameter, TY, Tint32, Tuns32, Tint64, Tuns64, Tfunction, Tsarray, TypeAArray, Tstruct, TypeStruct, isAggregate, Tpointer, Tdelegate, Ttuple, Tarray, TypeSArray, Taarray, Tclass, TypeClass, Tvoid, MODFlags, TypeDelegate, ParameterList, SIZE_INVALID, Tchar, Twchar, Tdchar, TypeEnum, Tenum, PURE, TypeIdentifier, isSomeChar;
import dmd.nogc : checkGC;
import dmd.opover : inferForeachAggregate, inferApplyArgTypes;
import dmd.root.outbuffer : OutBuffer;
import dmd.root.rmem : Pool;
import dmd.root.string : toDString;
import dmd.semantic2 : semantic2;
import dmd.sideeffect : discardValue, copyToTemp;
import dmd.statement : LabelStatement, Statement, ErrorStatement, PeelStatement, ExpStatement, CompileStatement, CompoundStatement, UnrolledLoopStatement, ScopeStatement, ForwardingStatement, WhileStatement, DoStatement, ForStatement, ForeachStatement, ForeachRangeStatement, IfStatement, ConditionalStatement, PragmaStatement, StaticAssertStatement, SwitchStatement, CaseStatement, CaseRangeStatement, DefaultStatement, GotoDefaultStatement, GotoCaseStatement, ReturnStatement, BreakStatement, ContinueStatement, SynchronizedStatement, WithStatement, TryCatchStatement, TryFinallyStatement, ScopeGuardStatement, ThrowStatement, DebugStatement, GotoStatement, AsmStatement, CompoundAsmStatement, ImportStatement, Catch, getThrowable, CompoundDeclarationStatement, DtorExpStatement, SwitchErrorStatement, LabelDsymbol;
