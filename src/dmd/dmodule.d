...
import core.stdc.string : strchr, memcmp, strlen, strcmp, memcpy;
import dmd.aggregate : AggregateDeclaration;
import dmd.arraytypes : Modules, Identifiers, Dsymbols;
...
import dmd.dsymbol : ScopeDsymbol, DsymbolTable, Dsymbol, SearchLocalsOnly, Prot, PASS, SearchUnqualifiedModule, IgnorePrivateImports;
import dmd.dsymbolsem : dsymbolSemantic;
import dmd.errors : fatal, message, error, errorSupplemental;
import dmd.expression : Expression, StringExp;
import dmd.expressionsem : semanticString;
import dmd.globals : Param, Loc, global;
import dmd.id : Id;
