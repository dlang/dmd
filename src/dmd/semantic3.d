...
import dmd.arraytypes : VarDeclarations, Objects, Statements, Catches, Dsymbols;
...
import dmd.declaration : VarDeclaration, STC, STCFlowThruFunction, TupleDeclaration;
// import dmd.denum : ;
// import dmd.dimport : ;
...
import dmd.dsymbol : Dsymbol, PASS, DsymbolTable, ScopeDsymbol, Prot;
import dmd.dsymbolsem : Module, dsymbolSemantic, allowsContractWithoutBody;
import dmd.dtemplate : TemplateInstance, TemplateMixin, TemplateDeclaration, isError;
// import dmd.dversion : ;
import dmd.errors : fatal, error;
import dmd.escape : checkReturnEscapeRef, checkReturnEscape, eliminateMaybeScopes, notMaybeScope;
import dmd.expression : VarExp, Expression, SuperExp, CallExp, IntegerExp, AssertExp, StringExp, HaltExp, CommaExp, WANTvalue, doCopyOrMove, BlitExp, AssignExp, DotIdExp, ConstructExp, DeclarationExp, PtrExp, IndexExp, ThisExp, DotVarExp, IdentifierExp;
import dmd.expressionsem : AttribDeclaration, symbolToExp, expressionSemantic;
import dmd.func : FuncDeclaration, CtorDeclaration, FUNCFLAG, addInvariant, resolveFuncCall, FuncResolveFlag, NrvoWalker;
import dmd.globals : global, LINK, StorageClass, Loc, CHECKENABLE, DiagnosticReporting;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.init : VoidInitializer, ExpInitializer;
// import dmd.initsem : ;
// import dmd.hdrgen : ;
import dmd.mtype : TypeFunction, Tvoid, Tfunction, Terror, VarArg, Type, Tarray, Ttuple, TypeTuple, Parameter, PURE, MODtoChars, isAggregate, TypeStruct, TypeClass, Tstruct, MODimplicitConv, TRUST;
import dmd.nogc : checkGC;
import dmd.nspace : Nspace;
import dmd.ob : oblive;
// import dmd.objc : ;
// import dmd.opover : ;
// import dmd.parse : ;
// import dmd.root.filename : ;
// import dmd.root.outbuffer : ;
import dmd.root.rmem : mem, Pool;
...
import dmd.statement : Statement, ExpStatement, CompoundStatement, ErrorStatement, ReturnStatement, LabelStatement, DtorExpStatement, TryFinallyStatement, PeelStatement, SynchronizedStatement, LabelDsymbol, ScopeStatement, ThrowStatement, Catch, getException, TryCatchStatement;
import dmd.target : target;
// import dmd.templateparamsem : ;
import dmd.typesem : defaultInit, typeSemantic;
