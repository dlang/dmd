...
import dmd.access : symbolIsVisible, checkAccess;
...
import dmd.complex : complex_t;
import dmd.dcast;
import dmd.dclass : ClassDeclaration;
import dmd.declaration : Declaration, STC, VarDeclaration, TupleDeclaration, TypeInfoClassDeclaration, SymbolDeclaration;
...
import dmd.dsymbol : Dsymbol, ScopeDsymbol, ArrayScopeSymbol, SearchLocalsOnly, IgnorePrivateImports, PASS, Prot, IgnoreSymbolVisibility, OverloadSet, foreachDsymbol;
import dmd.dsymbolsem : dsymbolSemantic;
import dmd.dtemplate : isExpression, isType, isDsymbol, getDsymbol, TemplateDeclaration, TemplateMixin, TemplateInstance;
import dmd.errors : error, fatal, errorSupplemental;
import dmd.expression : Expression, TypeExp, IndexExp, VarExp, ErrorExp, FuncExp, ArrayExp, IdentifierExp, ScopeExp, DotIdExp, DotTemplateInstanceExp, CallExp, WANTvalue, AddrExp, TupleExp, DotVarExp, DotTemplateExp, DsymbolExp, TemplateExp, DotTypeExp, OverExp, IntegerExp, StringExp, RealExp, ComplexExp, hasThis, getFuncTemplateDecl, isFuncAddress, IntervalExp, VectorArrayExp, ArrayLengthExp, DelegatePtrExp, DelegateFuncptrExp, CommaExp, DotExp, ThisExp, CastExp, PtrExp, AddExp, ObjcClassReferenceExp, VectorExp, NullExp, lastComma;
import dmd.expressionsem : symbolToExp, resolveProperties, expressionsToString, expressionSemantic, resolvePropertiesOnly, resolveAliasThis, getThisSkipNestedFuncs, semanticY;
import dmd.func : FuncDeclaration;
import dmd.globals : Loc, uinteger_t, global, dinteger_t, StorageClass, LINK, d_uns64, STRUCTALIGN_DEFAULT;
import dmd.hdrgen : stcToBuffer, stcToChars;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.imphint : importHint;
import dmd.init : Initializer, ExpInitializer, INITnointerpret;
import dmd.initsem : initializerSemantic, initializerToExpression;
// import dmd.visitor : ;
import dmd.mtype : Type, TypeQualified, TypeMixin, Terror, Ttuple, Parameter, TypeFunction, TypeTuple, Tenum, TypeNext, TypeSArray, TypeAArray, TypeIdentifier, TypeInstance, Tsarray, Taarray, Tident, Tinstance, Tmixin, Tint128, Tuns128, TypeVector, Tstruct, TypeStruct, TypeEnum, Tpointer, Tarray, Tclass, Tfunction, Tnone, TypeDArray, Ttypeof, Treturn, Tvoid, TypeClass, TypePointer, TypeReference, PURE, TRUST, MODimplicitConv, MODFlags, MODtoChars, VarArg, TypeDelegate, TypeTypeof, TypeTraits, TypeReturn, TypeSlice, Tvector, Treference, Tdelegate, Ttraits, Tslice, LOGDOTEXP, SIZE_INVALID, TypeError, TypeBasic, Tint8, Tuns8, Tint16, Tuns16, Tint32, Tuns32, Tint64, Tuns64, Tbool, Tchar, Twchar, Tdchar, Tcomplex32, Timaginary32, Tfloat32, Tcomplex64, Timaginary64, Tfloat64, Tcomplex80, Timaginary80, Tfloat80, DotExpFlag, TypeArray, LOGDEFAULTINIT, Tnull;
import dmd.objc : objc;
import dmd.opover : search_function, build_overload;
...
import dmd.sideeffect : extractSideEffect, isTrivialExp;
