...
import core.stdc.string : strlen, strcat;
...
import dmd.backend.cdef : SCauto, EX_WIN64, SCalias;
import dmd.backend.cc : block, Symbol, SFLtrue, SFLfree, config;
// import dmd.backend.dt : ;
import dmd.backend.el : elem, el_ptr, el_bin, el_long, el_una, el_var, el_combine, el_same;
import dmd.backend.global : symbol_genauto, symbol_name, symbol_add, block_appendexp;
import dmd.backend.oper : OPMAX, OPadd, OPind, OPaddass, OPeq, OPframeptr, OPaddr, OPabs, OPcos, OPsin, OPrint, OPsqrt, OPyl2x, OPscale, OPrndtol, OPyl2xp1, OPprefetch, OPvector, OPbsf, OPbsr, OPbtc, OPbtr, OPbts, OPinp, OPoutp, OPbswap, OPpopcnt, OPva_start, OP128_64, OP64_32, OPcall, OPstreq;
import dmd.backend.rtlsym : getRtlsym, RTLSYM_ALLOCMEMORY;
import dmd.backend.ty : TYnptr, TYuint, TYsize_t, tysize, TYvoid, tym_t, TYdelegate, TYnref, tybasic, TYstruct, TYarray;
import dmd.backend.type : TYPE, type, type_struct_class, symbol_struct_addField, type_pointer;
...
import dmd.e2ir : Blockx, toTraceGC, ISX64REF, ISREF;
import dmd.func : FuncDeclaration;
import dmd.globals : Param, Loc, global, CHECKENABLE, dinteger_t, structalign_t, STRUCTALIGN_DEFAULT;
import dmd.glue : totym;
import dmd.identifier : Identifier;
import dmd.id : Id;
import dmd.mtype : Type, RET, TypeFunction, Tfunction, TRUST, Tsarray, TypeSArray, Tarray;
import dmd.target : target;
import dmd.tocvdebug : toDebugClosure;
// import dmd.tocsym : ;
