...
import dmd.aggregate : AggregateDeclaration, Sizeok, ClassKind;
import dmd.arraytypes;
import dmd.blockexit : BE, blockExit;
// import dmd.gluelayer : ;
import dmd.dclass : BaseClass, ClassDeclaration;
import dmd.declaration : Declaration, VarDeclaration, STC, ThisDeclaration, AliasDeclaration, MatchAccumulator;
import dmd.delegatize : ensureStaticLinkTo;
// import dmd.dinterpret : ;
import dmd.dmodule : Module;
import dmd.dscope : Scope, SCOPE;
// import dmd.dstruct : ;
import dmd.dsymbol : DsymbolTable, Dsymbol, PASS, Prot;
import dmd.dsymbolsem : dsymbolSemantic;
import dmd.dtemplate : TemplateDeclaration, TemplateInstance, isDsymbol, arrayObjectIsError, functionResolve;
import dmd.errors : error, errorSupplemental, message, tip;
// import dmd.escape : ;
import dmd.expression : Symbol, Expression, IdentifierExp, CallExp, VarExp, DeclarationExp, CommaExp, ThisExp, DotVarExp;
import dmd.globals : Loc, PINLINE, StorageClass, MATCH, global, LINK, CHECKENABLE;
import dmd.hdrgen : functionToBufferWithIdent, arrayObjectsToBuffer, argExpTypesToCBuffer, parametersTypeToChars;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.init : ExpInitializer;
import dmd.mtype : Type, PURE, ParameterList, MODFlags, Tstruct, Tfunction, TypeFunction, Tident, Tinstance, Ttypeof, MODmethodConv, MODimplicitConv, TRUST, Tarray, Tpointer, Taarray, Tclass, Tvoid, Parameter, VarArg, Tchar, Tint32, MODtoChars, Terror;
import dmd.objc : ObjcFuncDeclaration, objc;
...
import dmd.statement_rewrite_walker : StatementRewriteWalker;
import dmd.statement : ReturnStatement, TryFinallyStatement, Statement, LabelDsymbol, ForeachStatement, GotoStatement, CompoundStatement, ExpStatement, DtorExpStatement, PeelStatement, ThrowStatement, Catch, getThrowable, TryCatchStatement, ScopeStatement;
import dmd.statementsem : catchSemantic;
