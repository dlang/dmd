...
import dmd.arraytypes : Expressions, Dsymbols;
// import dmd.astcodegen : ;
import dmd.attrib : DeprecatedDeclaration, AlignDeclaration, CPPNamespaceDeclaration, UserAttributeDeclaration, AttribDeclaration;
...
// import dmd.dstruct : ;
import dmd.dsymbol : Dsymbol, ScopeDsymbol, PASS;
import dmd.dsymbolsem : VarDeclaration, getMessage, dsymbolSemantic, getAlignment;
import dmd.dtemplate : TemplateInstance, TemplateMixin, TemplateDeclaration, definitelyValueParameter;
// import dmd.dversion : ;
import dmd.errors : errorSupplemental, error, fatal;
// import dmd.escape : ;
import dmd.expression : Expression, StringExp, AddrExp, ArrayLiteralExp, StructLiteralExp, AssocArrayLiteralExp, TupleExp;
import dmd.expressionsem : Module, Import, resolveProperties, expressionSemantic;
import dmd.func : FuncDeclaration, overloadApply;
import dmd.globals : global, LINK;
import dmd.id : Id;
// import dmd.identifier : ;
import dmd.init : INITnointerpret, INITinterpret, ExpInitializer;
import dmd.initsem : initializerSemantic;
import dmd.hdrgen : linkageToChars, parametersTypeToChars;
import dmd.mtype : Tclass, Tpointer, Tstruct, TypeFunction, Type, Tfunction;
// import dmd.nogc : ;
