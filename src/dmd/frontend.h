...
static STC const STCFlowThruAggregate = (STC)962072674304LLU;

static STC const STCFlowThruFunction = (STC)18446742978991225440LLU;

static STC const STCStorageClass = (STC)7954966262857631LLU;
