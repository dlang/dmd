...
import core.stdc.string : memcpy, strncmp;
// import dmd.apply : ;
import dmd.arraytypes : Expressions, VarDeclarations;
import dmd.attrib : AttribDeclaration;
import dmd.builtin : isBuiltin, eval_builtin;
import dmd.constfold : Neg, Com, Not, Add, Min, Mul, Div, Mod, Shl, Shr, Ushr, And, Or, Xor, Pow, sliceAssignStringFromString, sliceAssignStringFromArrayLiteral, sliceAssignArrayLiteralFromString, ArrayLength;
import dmd.ctfeexpr : ThrownExceptionExp, ClassReferenceExp, CTFEExp, copyLiteral, exceptionOrCantInterpret, isTrueBool, isPointer, needToCopyLiteral, ctfeEqual, isTypeInfo_Class, isSafePointerCast, paintTypeOntoLiteral, voidInitLiteral, createBlockDuplicatedArrayLiteral, createBlockDuplicatedStringLiteral, pointerDifference, pointerArithmetic, getAggregateFromPointer, comparePointers, isCtfeComparable, ctfeIdentity, ctfeCmp, resolveSlice, findKeyInAA, assignAssocArrayElement, ctfeCast, changeArrayLiteralLength, findFieldIndexByName, assignInPlace, resolveArrayLength, isAssocArray, ctfeCat, pointToSameMemoryBlock, ctfeIndex, isFloatIntPaint, paintFloatInt, toBuiltinAAType, isCtfeReferenceValid, isCtfeValueValid;
import dmd.dclass : ClassDeclaration;
import dmd.declaration : VarDeclaration, Declaration, STC, SymbolDeclaration, TupleDeclaration;
import dmd.dstruct : StructDeclaration;
import dmd.dsymbol : PASS, Dsymbol;
import dmd.dsymbolsem : dsymbolSemantic;
import dmd.dtemplate : isExpression, isType, TemplateInstance;
import dmd.errors : error, errorSupplemental, message;
import dmd.expression : Expression, UnionExp, TypeExp, ThisExp, NullExp, IntegerExp, RealExp, ComplexExp, StringExp, FuncExp, SymOffExp, AddrExp, DelegateExp, VarExp, DeclarationExp, TypeidExp, TupleExp, ArrayLiteralExp, AssocArrayLiteralExp, StructLiteralExp, NewExp, UnaExp, DotTypeExp, BinExp, fp_t, fp2_t, AssignExp, BinAssignExp, PostExp, LogicalExp, CallExp, CommaExp, CondExp, ArrayLengthExp, VectorExp, VectorArrayExp, DelegatePtrExp, DelegateFuncptrExp, IndexExp, SliceExp, InExp, CatExp, DeleteExp, CastExp, AssertExp, PtrExp, DotVarExp, RemoveExp, VoidInitExp, ErrorExp, expandTuples, emplaceExp, DsymbolExp, OwnedBy, MemorySet, NotExp, SymbolExp, firstComma, stageScrub;
import dmd.expressionsem : expressionSemantic;
import dmd.func : FuncDeclaration, BUILTIN;
import dmd.globals : Loc, uinteger_t, global, d_uns64, dinteger_t, sinteger_t;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.init : INITinterpret, ExpInitializer;
import dmd.initsem : initializerSemantic, initializerToExpression;
import dmd.mtype : Type, Terror, TypeTuple, Tfunction, TypeFunction, VarArg, Parameter, Tsarray, Tstruct, Tvoid, Tdelegate, Tclass, Tuns32, Tpointer, TypePointer, Tarray, TypeArray, TypeSArray, TypeNext, MODFlags, Taarray, TypeStruct, Tvector, Tbool, isSomeChar;
import dmd.root.rmem : mem;
import dmd.root.array : Array;
import dmd.root.region : Region;
import dmd.root.rootobject : RootObject, DYNCAST;
import dmd.statement : Statement, ExpStatement, CompoundStatement, UnrolledLoopStatement, IfStatement, ScopeStatement, ReturnStatement, BreakStatement, ContinueStatement, WhileStatement, DoStatement, ForStatement, ForeachStatement, ForeachRangeStatement, SwitchStatement, CaseStatement, DefaultStatement, GotoStatement, GotoCaseStatement, GotoDefaultStatement, LabelStatement, TryCatchStatement, TryFinallyStatement, ThrowStatement, ScopeGuardStatement, WithStatement, AsmStatement, ImportStatement, LabelDsymbol;
import dmd.tokens : TOK, Token;
import dmd.utf : utf_decodeChar, utf_decodeWchar, utf_codeLengthChar, utf_encodeChar, utf_codeLengthWchar, utf_encodeWchar;
