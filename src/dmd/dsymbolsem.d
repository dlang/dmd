...
import dmd.aggregate : AggregateDeclaration, Sizeok, ClassKind, Baseok;
import dmd.aliasthis : AliasThis;
import dmd.arraytypes;
import dmd.astcodegen : ASTCodegen;
import dmd.attrib : AlignDeclaration, DeprecatedDeclaration, AttribDeclaration, AnonDeclaration, PragmaDeclaration, StaticIfDeclaration, StaticForeachDeclaration, CompileDeclaration, CPPNamespaceDeclaration, UserAttributeDeclaration, StorageClassDeclaration;
// import dmd.blockexit : ;
import dmd.clone : mergeFuncAttrs, buildDtor, buildExternDDtor, buildOpAssign, buildOpEquals, buildXopEquals, buildXopCmp, buildXtoHash, buildInv, hasIdentityOpAssign;
import dmd.compiler : rootHasMain;
import dmd.dcast;
import dmd.dclass : ClassDeclaration, InterfaceDeclaration, Abstract, BaseClass;
import dmd.declaration : Declaration, AliasDeclaration, VarDeclaration, TypeInfoDeclaration, STC, TupleDeclaration, checkFrameAccess;
import dmd.denum : EnumDeclaration, EnumMember;
import dmd.dimport : Import;
import dmd.dinterpret : ctfeInterpretForPragmaMsg;
import dmd.dmangle : isValidMangling;
import dmd.dmodule : Package, Module;
import dmd.dscope : Scope, SCOPE;
import dmd.dstruct : StructDeclaration, UnionDeclaration;
import dmd.dsymbol : Dsymbol, ScopeDsymbol, PASS, IgnorePrivateImports, DsymbolTable, Prot, Ungag, foreachDsymbol;
import dmd.dtemplate : TemplateDeclaration, TemplateInstance, TemplateMixin, getDsymbol, TemplateParameter, TemplateTypeParameter, reliesOnTident, TemplateAliasParameter, isType, isExpression, isDsymbol, isError, TemplateStats, TemplateInstanceBox, TemplateTupleParameter, Tuple, isTuple;
import dmd.dversion : DebugSymbol, VersionSymbol;
import dmd.errors : error, errorSupplemental, message, fatal, deprecation;
// import dmd.escape : ;
import dmd.expression : Expression, ThisExp, DotVarExp, AddrExp, CastExp, PtrExp, CallExp, DotIdExp, SliceExp, IntegerExp, IdentifierExp, AssignExp, TupleExp, isAliasThisTuple, VarExp, expandAliasThisTuples, CommaExp, DeclarationExp, ErrorExp, DsymbolExp, BlitExp, ConstructExp, WANTvalue, NewExp, FuncExp, ScopeExp, StringExp, expandTuples, EqualExp, AddExp, AddAssignExp, lastComma;
import dmd.expressionsem : resolveProperties, semanticString, expressionsToString, arrayExpressionSemantic, expressionSemantic;
import dmd.func : FuncDeclaration, CtorDeclaration, PostBlitDeclaration, DtorDeclaration, StaticCtorDeclaration, StaticDtorDeclaration, InvariantDeclaration, UnitTestDeclaration, NewDeclaration, overloadApply, FUNCFLAG, FuncLiteralDeclaration, resolveFuncCall, FuncResolveFlag;
import dmd.globals : StorageClass, structalign_t, Loc, LINK, global, STRUCTALIGN_DEFAULT, MATCH, d_uns64;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.init : Initializer, ExpInitializer, ArrayInitializer, INITnointerpret, ErrorInitializer, INITinterpret, syntaxCopy;
import dmd.initsem;
import dmd.hdrgen : stcToBuffer, protectionToBuffer, protectionToChars, HdrGenState, functionToBufferFull;
import dmd.mtype : Type, Tstruct, TypeStruct, TypeFunction, Parameter, ParameterList, MOD, MODFlags, ModToStc, Terror, Tvoid, Tfunction, SIZE_INVALID, Tsarray, Taarray, Tclass, Tdelegate, Tpointer, PURE, TRUST, MODtoBuffer, Tchar, VarArg, TypeIdentifier, TypeClass, Tident;
// import dmd.nogc : ;
...
import dmd.root.rmem : mem, xarraydup, Pool;
...
import dmd.statement : Statement, ExpStatement, ScopeGuardStatement, CompoundStatement, IfStatement, ReturnStatement;
import dmd.target : target;
import dmd.templateparamsem : tpsemantic;
import dmd.typesem : typeSemantic, defaultInit, getProperty, resolve;
