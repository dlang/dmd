...
import dmd.arraytypes : Objects, TemplateParameters, Modules, Expressions, TemplateInstances, Dsymbols, Types, Parameters;
import dmd.ast_node : ASTNode;
import dmd.dcast : toStaticArrayType;
import dmd.dclass : BaseClass, ClassDeclaration;
import dmd.declaration : MatchAccumulator, Declaration, VarDeclaration, STC, AliasDeclaration, TupleDeclaration, OverDeclaration;
import dmd.dmangle : mangleToBuffer;
import dmd.dmodule : Module;
import dmd.dscope : Scope, SCOPE;
import dmd.dsymbol : Dsymbol, ScopeDsymbol, WithScopeSymbol, Prot, DsymbolTable, PASS, Ungag, OverloadSet, foreachDsymbol;
import dmd.dsymbolsem : aliasSemantic, dsymbolSemantic, templateInstanceSemantic;
import dmd.errors : error, errorSupplemental, tip, fatal, message;
import dmd.expression : Expression, VarExp, IntegerExp, RealExp, ComplexExp, IdentifierExp, NullExp, TupleExp, ArrayLiteralExp, AssocArrayLiteralExp, StructLiteralExp, FuncExp, WANTvalue, StringExp, SliceExp, ScopeExp, ThisExp, CommaExp, TypeExp, NewExp, NewAnonClassExp, TypeidExp, TraitsExp, IsExp, UnaExp, DotTemplateInstanceExp, CallExp, CastExp, IntervalExp, ArrayExp, BinExp, CondExp, ErrorExp, DotVarExp, TemplateExp, DotTemplateExp, DotExp;
import dmd.expressionsem : resolveProperties, resolveAliasThis, expressionSemantic;
import dmd.func : FuncDeclaration, CtorDeclaration, resolveFuncCall, FuncResolveFlag, overloadApply, FuncAliasDeclaration;
...
import dmd.mtype : Type, Parameter, TypeQualified, Terror, TypeFunction, Tfunction, VarArg, ParameterList, Tident, TypeIdentifier, MODFlags, MODmerge, MODmethodConv, Ttuple, TypeTuple, Tvoid, Tarray, Tpointer, Tnone, Tsarray, Taarray, TypeAArray, isAggregate, TypeSArray, TypeArray, Tclass, Tenum, TypeNext, ModToStc, MODimplicitConv, TY, TypeVector, TypeDArray, TypeInstance, TypeStruct, TypeEnum, TypeClass, Ttypeof, AliasThisRec, Tstruct, Tvector, Tinstance, Tnull, Tdelegate, TypeDelegate, TypeTypeof;
// import dmd.opover : ;
