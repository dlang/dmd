...
import core.stdc.stdlib : calloc, free, malloc, qsort;
...
import dmd.backend.cdef : SCglobal, SCstatic, EX_WIN64, SCcomdat, SCparameter, SCshadowreg, SCfastpar, SCauto, EHmethod, EX_WIN32;
import dmd.backend.cc : Symbol, cstate, block, BCret, FLdata, SFLhidden, config, func_t, Classsym, Ffakeeh, Feh_none, Fnested, SFLtrue, SFLfree, Fmember, SFLspill, FLpara, FLfast, Blockx, Fjmonitor, BlockRange, BCretexp, SFLnodebug;
import dmd.backend.code : FuncParamRegs, Para;
import dmd.backend.dt : DtBuilder, dt2common;
import dmd.backend.el : elem, el_var, el_bin, el_long, el_combine, el_una, el_reset, el_pair, el_ptr, el_params;
import dmd.backend.global : localgot, block_calloc, writefunc, rtlsym_reset, cg87_reset, out_reset, symbol_generate, outdata, symbol_calloc, symbol_name, symbol_add, block_appendexp;
import dmd.backend.obj : Obj, objmod;
import dmd.backend.oper : OPaddass, OPucall, OPcall, OPva_start, OPminass;
import dmd.backend.outbuf : Outbuffer;
import dmd.backend.rtlsym : getRtlsym, RTLSYM_DCOVER2;
import dmd.backend.symtab : symtab_t;
import dmd.backend.ty : TYnfunc, TYvoid, TYint, TYnptr, TYuint, TYdarray, TYsize_t, TYuchar, tym_t, tybasic, tyrevfunc, mTYvolatile, TYschar, TYshort, TYushort, TYllong, TYullong, TYfloat, TYdouble, TYldouble, TYifloat, TYidouble, TYildouble, TYcfloat, TYcdouble, TYcldouble, TYbool, TYchar, TYwchar_t, TYdchar, TYulong, TYaarray, TYdelegate, TYstruct, TYlong, TYschar32, TYschar16, TYuchar32, TYuchar16, TYshort16, TYshort8, TYushort16, TYushort8, TYlong8, TYlong4, TYulong8, TYulong4, TYllong4, TYllong2, TYullong4, TYullong2, TYfloat8, TYfloat4, TYdouble4, TYdouble2, TYnsfunc, TYnpfunc, TYhfunc, TYjfunc, mTYnothrow;
import dmd.backend.type : type, type_function, tstypes, mTYman_c, type_fake, mTYman_d, type_setcv, type_struct_class, type_static_array;

import dmd.aggregate : AggregateDeclaration;
import dmd.arraytypes : StaticDtorDeclarations, SharedStaticDtorDeclarations, Dsymbols, Expressions;
...
import dmd.e2ir : clearStringTab, addressElem, toStringSymbol;
import dmd.errors : message, error;
import dmd.expression : StringExp, Expression, VarExp, CallExp;
import dmd.func : UnitTestDeclaration, FuncDeclaration, SharedStaticDtorDeclaration, StaticDtorDeclaration;
import dmd.globals : Loc, global, LINK;
import dmd.identifier : Identifier;
import dmd.id : Id;
import dmd.lib : Library;
import dmd.mtype : Type, Tfunction, TypeFunction, Terror, RET, Tvoid, Tint8, Tuns8, Tint16, Tuns16, Tint32, Tuns32, Tint64, Tuns64, Tfloat32, Tfloat64, Tfloat80, Timaginary32, Timaginary64, Timaginary80, Tcomplex32, Tcomplex64, Tcomplex80, Tbool, Tchar, Twchar, Tdchar, Taarray, Tclass, Treference, Tpointer, Tdelegate, Tarray, Tsarray, Tstruct, Tenum, Tident, Ttypeof, Tmixin, Tnull, Tvector, TypeVector, VarArg, TypeClass;
import dmd.objc_glue : objc;
import dmd.s2ir : Statement_toIR, insertFinallyBlockGotos, insertFinallyBlockCalls;
import dmd.statement : Statement, ExpStatement, CompoundStatement, TryFinallyStatement;
import dmd.target : target;
import dmd.tocsym : toSymbolX;
import dmd.toctype : Type_toCtype, modToTym;
import dmd.toir : Label, IRState, retStyle, getParentClosureType, fixEthis2, buildClosure, buildCapture;
import dmd.toobj : toObjFile, genModuleInfo;
