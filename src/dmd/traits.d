...
import dmd.aggregate : Sizeok, AggregateDeclaration, ClassKind;
import dmd.arraytypes : Expressions, Identifiers, Objects;
import dmd.astcodegen : ASTCodegen;
import dmd.attrib : UserAttributeDeclaration;
import dmd.canthrow : canThrow;
import dmd.dclass : InterfaceDeclaration, ClassDeclaration;
import dmd.declaration : STC, Declaration;
import dmd.denum : EnumMember;
// import dmd.dimport : ;
import dmd.dmodule : Package;
import dmd.dscope : Scope, SCOPE;
import dmd.dsymbol : Dsymbol, PASS, ScopeDsymbol, foreachDsymbol;
import dmd.dsymbolsem : dsymbolSemantic;
import dmd.dtemplate : isExpression, getDsymbol, getType, TemplateInstance, isType, isParameter, isError, TemplateInstanceBox, TemplateDeclaration, isDsymbol;
import dmd.errors : error;
import dmd.expression : Expression, TraitsExp, DotVarExp, DotTemplateExp, ErrorExp, IntegerExp, ArrayLiteralExp, StringExp, getFuncTemplateDecl, TemplateExp, VarExp, DsymbolExp, DotExp, ScopeExp, typeDotIdExp, DotIdExp, TupleExp, WANTvalue, FuncExp;
import dmd.expressionsem : resolveIsPackage, symbolToExp, expressionsToString, resolvePropertiesOnly, expressionSemantic, trySemantic;
import dmd.func : FuncDeclaration, overloadApply, FuncAliasDeclaration, FuncLiteralDeclaration;
import dmd.globals : d_uns64, Loc, global, LINK, StorageClass;
import dmd.hdrgen : protectionToString, linkageToChars;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.mtype : Type, Tclass, TypeClass, SIZE_INVALID, TypeError, TypeNext, TypeBasic, TypeVector, TypeArray, TypeSArray, TypeDArray, TypeAArray, TypePointer, TypeReference, TypeFunction, TypeDelegate, TypeQualified, TypeIdentifier, TypeInstance, TypeTypeof, TypeReturn, TypeEnum, TypeTuple, TypeSlice, TypeNull, TypeStruct, Tvoid, Tfunction, Tdelegate, Tpointer, Taarray, Tsarray, Tstruct, isCopyable, VarArg, ParameterList, Parameter, MODFlags, Terror, modifiersApply, attributesApply, TRUSTformatSystem;
...
import dmd.typesem : typeToExpression, resolve, typeSemantic;
