...
import dmd.arraytypes : Statements, Expressions, ScopeStatements, Parameters, GotoCaseStatements, CaseStatements, Catches, Identifiers, GotoStatements, Dsymbols;
import dmd.attrib : StorageClassDeclaration, DeprecatedDeclaration, LinkDeclaration, ProtDeclaration, AlignDeclaration, UserAttributeDeclaration, ForwardingAttribDeclaration, PragmaDeclaration, ConditionalDeclaration, StaticForeachDeclaration, CompileDeclaration;
import dmd.astcodegen : ASTCodegen;
// import dmd.ast_node : ;
import dmd.gluelayer : code;
// import dmd.canthrow : ;
import dmd.cond : ASTNode, Condition, StaticForeach, DebugCondition;
// import dmd.dclass : ;
import dmd.declaration : VarDeclaration, AliasDeclaration, STC;
import dmd.denum : EnumDeclaration;
import dmd.dimport : Import;
import dmd.dscope : Scope;
import dmd.dsymbol : Dsymbol, ForwardingScopeDsymbol, DsymbolTable;
import dmd.dsymbolsem : dsymbolSemantic;
import dmd.dtemplate : TemplateMixin, TemplateDeclaration;
import dmd.errors : verror, vwarning, vdeprecation, error;
import dmd.expression : Expression, DeclarationExp, CallExp, IntegerExp, AssignExp, VarExp, NotExp;
import dmd.expressionsem : expressionsToString, expressionSemantic;
import dmd.func : FuncDeclaration;
import dmd.globals : Loc, StorageClass, global;
import dmd.hdrgen : HdrGenState, toCBuffer;
import dmd.id : Id;
import dmd.identifier : Identifier;
// import dmd.dinterpret : ;
import dmd.mtype : TypeIdentifier, Parameter, Type;
...
import dmd.visitor : Visitor, StoppableVisitor, SemanticTimeTransitiveVisitor;
