...
import dmd.access : checkAccess, symbolIsVisible;
import dmd.aggregate : AggregateDeclaration, ClassKind, Sizeok;
import dmd.aliasthis : AliasThis;
import dmd.arrayop : checkNonAssignmentArrayOp, arrayOp, isNonAssignmentArrayOp, isArrayOpValid, arrayOpInvalidError, isArrayOpOperand, isUnaArrayOp, isBinArrayOp;
import dmd.arraytypes : Expressions, Objects, Parameters, Identifiers, Dsymbols;
import dmd.attrib : AttribDeclaration;
import dmd.astcodegen : ASTCodegen;
import dmd.canthrow : canThrow;
import dmd.chkformat : checkPrintfFormat, checkScanfFormat;
import dmd.ctorflow : CSX, CtorFlow;
import dmd.dscope : Scope, SCOPE;
import dmd.dsymbol : Dsymbol, ArrayScopeSymbol, PASS, SearchUnqualifiedModule, IgnoreSymbolVisibility, SearchLocalsOnly, SearchImportsOnly, OverloadSet, WithScopeSymbol, ExpressionDsymbol, ScopeDsymbol, Prot, IgnorePrivateImports;
import dmd.declaration : VarDeclaration, STC, AliasDeclaration, Declaration, OverDeclaration, TupleDeclaration, checkFrameAccess;
import dmd.dclass : ClassDeclaration, BaseClass;
import dmd.dcast;
import dmd.delegatize : toDelegate, ensureStaticLinkTo;
...
import dmd.dstruct : semanticTypeInfo, StructDeclaration;
import dmd.dsymbolsem : dsymbolSemantic, getMessage;
import dmd.dtemplate : TemplateDeclaration, TemplateInstance, TemplateParameter, isType, isExpression, isDsymbol, getDsymbol, Tuple, isTuple, unSpeculative, TemplateTypeParameter, deduceType, TemplateMixin, matchArg;
import dmd.errors : error, errorSupplemental, message, deprecation, deprecationSupplemental;
import dmd.escape : checkParamArgumentReturn, checkParamArgumentEscape, checkMutableArguments, checkAssocArrayLiteralEscape, checkNewEscape, checkConstructorEscape, checkAssignEscape;
import dmd.expression : StringExp, Expression, UnaExp, ArrayExp, IntervalExp, CallExp, BinExp, IntegerExp, RealExp, ComplexExp, IdentifierExp, DsymbolExp, ThisExp, SuperExp, NullExp, TupleExp, ArrayLiteralExp, AssocArrayLiteralExp, StructLiteralExp, TypeExp, ScopeExp, NewExp, NewAnonClassExp, SymOffExp, VarExp, FuncExp, DeclarationExp, TypeidExp, TraitsExp, HaltExp, IsExp, BinAssignExp, CompileExp, ImportExp, AssertExp, DotIdExp, DotTemplateExp, DotVarExp, DotTemplateInstanceExp, DelegateExp, DotTypeExp, AddrExp, PtrExp, NegExp, UAddExp, ComExp, NotExp, DeleteExp, CastExp, VectorExp, VectorArrayExp, SliceExp, ArrayLengthExp, DotExp, CommaExp, DelegatePtrExp, DelegateFuncptrExp, IndexExp, PostExp, PreExp, AssignExp, PowAssignExp, CatAssignExp, AddExp, MinExp, CatExp, MulExp, DivExp, ModExp, PowExp, ShlExp, ShrExp, UshrExp, AndExp, OrExp, XorExp, LogicalExp, CmpExp, InExp, RemoveExp, EqualExp, IdentityExp, CondExp, FileInitExp, LineInitExp, ModuleInitExp, FuncInitExp, PrettyFuncInitExp, ErrorExp, lastComma, getFuncTemplateDecl, isDotOpDispatch, TemplateExp, hasThis, OverExp, ObjcClassReferenceExp, doCopyOrMove, expandTuples, isDefaultInitOp, WANTvalue, isNeedThisScope, expToVariable, isFuncAddress, AddAssignExp, MinAssignExp, isAliasThisTuple, expandAliasThisTuples, Modifiable, ConstructExp, MemorySet, BlitExp, valueNoDtor, typeDotIdExp, CatElemAssignExp, CatDcharAssignExp;
import dmd.func : FuncDeclaration, resolveFuncCall, FuncResolveFlag, FUNCFLAG, MODMatchToBuffer;
import dmd.globals : Loc, global, PINLINE, MATCH, LINK, sinteger_t, DiagnosticReporting, CHECKACTION, CHECKENABLE, uinteger_t, dinteger_t, d_int64;
import dmd.hdrgen : parametersTypeToChars, argExpTypesToCBuffer;
import dmd.id : Id;
import dmd.identifier : Identifier;
import dmd.imphint : importHint;
import dmd.init : INITinterpret;
import dmd.initsem : initializerSemantic;
import dmd.inline : inlineCopy;
import dmd.intrange : IntRange, SignExtendedNumber;
import dmd.mtype : Type, TypeFunction, Terror, TypeSArray, isAggregate, Tfunction, Tdelegate, Tpointer, Tarray, Tsarray, Tnull, Tvoid, Taarray, MODtoChars, TypeAArray, Tstruct, TypeStruct, VarArg, MOD, Parameter, TypeArray, Tclass, MODmerge, MODFlags, Tfloat32, Timaginary32, TRUST, TypeTuple, MODimplicitConv, TypeDArray, TypeNext, Ttuple, TypeClass, TypeDelegate, TypePointer, Tident, TypeIdentifier, ParameterList, Tenum, TypeEnum, Tvector, TypeVector, Tbool, MODmethodConv, isIndexableNonAggregate, Tchar, Twchar, Tfloat64, Timaginary64, Tfloat80, Timaginary80, Tcomplex32, Tcomplex64, Tcomplex80, DotExpFlag, TypeTypeof, isSomeChar, isCopyable;
import dmd.nspace : Nspace;
import dmd.opover : search_function, op_overload;
import dmd.optimize : expandVar, setLengthVarIfKnown;
...
import dmd.sideeffect : hasSideEffect, isTrivialExp, extractSideEffect, copyToTemp, discardValue;
import dmd.safe : checkUnsafeAccess, isSafeCast;
