...
/**
 * Converts the given root Array to the standard D array.
 * Params:
 *  array = the array to convert.
 * Returns:
 *  The given array converted to a standard D array.
 */
@property T[] toDArray(T)(ref Array!T array)
{
...
unittest
{
    ...
    array.split(0, 0);
    assert([] == array.toDArray);
    array.push(1);
    array.push(3);
    array.split(1, 1);
    array[1] = 2;
    assert([1, 2, 3] == array.toDArray);
    array.split(2, 3);
    array[2] = 8;
    array[3] = 20;
    array[4] = 4;
    assert([1, 2, 8, 20, 4, 3] == array.toDArray);
    array.split(0, 0);
    assert([1, 2, 8, 20, 4, 3] == array.toDArray);
    array.split(0, 1);
    array[0] = 123;
    assert([123, 1, 2, 8, 20, 4, 3] == array.toDArray);
    array.split(0, 3);
    array[0] = 123;
    array[1] = 421;
    array[2] = 910;
    assert([123, 421, 910, 123, 1, 2, 8, 20, 4, 3] == array.toDArray);
}
