...
import dmd.arrayop : isBinArrayOp, isArrayOpOperand, isArrayOpImplicitCast;
...
// import dmd.errors : ;
import dmd.escape : checkArrayLiteralEscape;
import dmd.expression : Expression, SliceExp, BinExp, UnaExp, StringExp, ErrorExp, FuncExp, ArrayLiteralExp, CastExp, WANTvalue, AddExp, MinExp, IntegerExp, NullExp, StructLiteralExp, AssocArrayLiteralExp, CallExp, AddrExp, SymOffExp, DelegateExp, AndExp, OrExp, XorExp, CondExp, CommaExp, NewExp, OverExp, RealExp, ComplexExp, TupleExp, VarExp, VectorExp, isFuncAddress, hasThis, ThisExp, MulExp, DivExp, ModExp, ShlExp, ShrExp, UshrExp, AssignExp, ComExp, NegExp;
import dmd.expressionsem : resolveAliasThis, expressionSemantic;
import dmd.func : getIndirection, FuncDeclaration;
import dmd.globals : MATCH, global, dinteger_t, sinteger_t, Loc, d_uns64;
import dmd.impcnvtab : impcnvResult, impcnvType1, impcnvType2;
import dmd.id : Id;
import dmd.init : Initializer, ExpInitializer;
import dmd.intrange : IntRange, SignExtendedNumber;
import dmd.mtype : Type, isAggregate, Tclass, Terror, toAutoQualChars, Tsarray, MOD, Tpointer, Tarray, TY, Tenum, TypeBasic, Tvoid, Tbool, Tint8, Tchar, Tuns8, Tint16, Tuns16, Twchar, Tint32, Tdchar, Tuns32, Tuns64, Tfloat32, Tfloat64, Tfloat80, Tstruct, TypeStruct, TypeSArray, TypeEnum, Tvector, TypeVector, Taarray, PURE, MODFlags, Parameter, Tdelegate, Tfunction, TypeFunction, TypeClass, Tnull, TypeAArray, MODmerge, Ttuple, TRUST, TypeDelegate, isSomeChar;
import dmd.opover : isCommutative;
import dmd.root.ctfloat : real_t;
import dmd.root.outbuffer : OutBuffer;
import dmd.root.rmem : mem;
import dmd.tokens : TOK, Token;
import dmd.typesem : typeSemantic;
import dmd.utf : utf_decodeChar, utf_decodeWchar, utf_isValidDchar;
