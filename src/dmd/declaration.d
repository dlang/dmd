...
public import dmd.storage_class;
import dmd.target;
import dmd.tokens;
import dmd.typesem;
import dmd.visitor;
    ...
    override Type getType()
    {
        ...
        if (!tupletype)
        {
            ...
            for (size_t i = 0; i < types.dim; i++)
            {
                ...
                {
                    auto arg = new Parameter(STC.undefined, t, null, null, null);
                }
                (*args)[i] = arg;
                if (!t.deco)
                    hasdeco = 0;
...
extern (C++) class VarDeclaration : Declaration
{
    ...
    final extern (D) this(const ref Loc loc, Type type, Identifier ident, Initializer _init, StorageClass storage_class = STC.undefined)
    {
    ...
    static VarDeclaration create(const ref Loc loc, Type type, Identifier ident, Initializer _init, StorageClass storage_class = STC.undefined)
    {
