...
import dmd.constfold : isConst;
import dmd.ctfeexpr : ClassReferenceExp, CTFEExp;
import dmd.ctorflow : CSX;
import dmd.dcast : implicitCastTo, implicitConvTo, castTo;
import dmd.dclass : ClassDeclaration;
import dmd.declaration : Declaration, TupleDeclaration, VarDeclaration, STC, modifyFieldVar;
// import dmd.delegatize : ;
// import dmd.dimport : ;
import dmd.dinterpret : ctfeInterpret;
// import dmd.dmodule : ;
import dmd.dscope : Scope, SCOPE;
import dmd.dstruct : StructDeclaration, semanticTypeInfo;
import dmd.dsymbol : Dsymbol, ScopeDsymbol, OverloadSet, PASS, DsymbolTable;
import dmd.dsymbolsem : dsymbolSemantic;
import dmd.dtemplate : TemplateDeclaration, TemplateInstance, getDsymbol, objectSyntaxCopy, isExpression, isType;
import dmd.errors : verror, verrorSupplemental, vwarning, vdeprecation, errorSupplemental, error;
// import dmd.escape : ;
import dmd.expressionsem : resolveAliasThis, symbolToExp, expressionSemantic, checkSharedAccess;
import dmd.func : FuncDeclaration, DtorDeclaration, CtorDeclaration, NewDeclaration, FuncLiteralDeclaration, MODMatchToBuffer;
import dmd.globals : Loc, dinteger_t, uinteger_t, MATCH, global, d_int32, d_uns64, d_int64, d_int8, d_uns8, d_int16, d_uns16, d_uns32, sinteger_t;
import dmd.hdrgen : HdrGenState, toCBuffer, functionToBufferWithIdent;
import dmd.id : Id;
import dmd.identifier : Identifier;
// import dmd.inline : ;
import dmd.mtype : Type, TY, TypeVector, Tsarray, MODtoChars, Tvoid, Terror, Tbool, PURE, Tstruct, TypeStruct, MODimplicitConv, TRUST, Tuns64, Tint8, Tchar, Tuns8, Tint16, Twchar, Tuns16, Tint32, Tdchar, Tuns32, Tint64, Tpointer, Tclass, TypeFunction, Tdelegate, Parameter, TypeDelegate, toAutoQualChars, Timaginary32, Timaginary64, Timaginary80, Taarray, Tvector, Tarray, isSomeChar;
// import dmd.nspace : ;
import dmd.objc : objc;
import dmd.opover : search_function;
import dmd.optimize : Expression_optimize;
import dmd.root.ctfloat : real_t, CTFloat;
import dmd.root.filename : FileName;
import dmd.root.outbuffer : OutBuffer;
import dmd.root.rmem : allocmemory, mem, Pool;
import dmd.root.rootobject : DYNCAST, RootObject;
import dmd.root.string : toDString;
import dmd.safe : checkUnsafeAccess;
import dmd.sideeffect : copyToTemp, extractSideEffect;
import dmd.target : target;
import dmd.tokens : TOK, Token;
import dmd.typesem : merge;
import dmd.utf : utf_decodeChar, utf_codeLength, utf_decodeWchar;
