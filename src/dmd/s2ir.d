...
import dmd.declaration : TypeInfoClassDeclaration, Declaration;
// import dmd.denum : ;
// import dmd.dmodule : ;
import dmd.dsymbol : Dsymbol;
// import dmd.dstruct : ;
import dmd.dtemplate : getDsymbol;
import dmd.e2ir : toElemDtor, elAssign, addressElem;
// import dmd.errors : ;
import dmd.expression : Expression, BlitExp, VarExp, CallExp;
import dmd.func : FuncDeclaration;
import dmd.globals : Loc;
import dmd.glue : totym;
import dmd.id : Id;
// import dmd.init : ;
import dmd.mtype : RET, Type, Tdelegate, Tfunction, TypeFunction;
import dmd.statement : Statement, ScopeGuardStatement, IfStatement, PragmaStatement, WhileStatement, DoStatement, ForStatement, ForeachStatement, ForeachRangeStatement, BreakStatement, ContinueStatement, GotoStatement, LabelStatement, SwitchStatement, CaseStatement, DefaultStatement, GotoDefaultStatement, GotoCaseStatement, SwitchErrorStatement, ReturnStatement, ExpStatement, CompoundStatement, UnrolledLoopStatement, ScopeStatement, WithStatement, ThrowStatement, TryCatchStatement, TryFinallyStatement, SynchronizedStatement, InlineAsmStatement, ImportStatement, LabelDsymbol;
// import dmd.stmtstate : ;
// import dmd.target : ;
// import dmd.toctype : ;
import dmd.tocsym : toSymbolCpp;
import dmd.toir : IRState, incUsageElem, retStyle;
import dmd.tokens : TOK;
import dmd.visitor : Visitor;

import dmd.backend.cc : block, Srcpos, Blockx, config, Feh_none, BCiftrue, BCgoto, Symbol, BCswitch, BC, BCretexp, BCret, BC_finally, BCexit, BC_try, BCjcatch, func_t, BC_lpad, BC_ret, FLblockoff, FLblock, FLdsymbol, FLfunc, FLauto, SFLlivexit, BCasm, BlockRange;
import dmd.backend.cdef : EHmethod, SCpseudo, SCauto, targ_llong;
// import dmd.backend.cgcv : ;
// import dmd.backend.code : ;
import dmd.backend.code_x86 : code;
// import dmd.backend.cv4 : ;
import dmd.backend.dlist : list_subtract;
// import dmd.backend.dt : ;
import dmd.backend.el : elem, el_bin, el_copytree, el_var, el_una, el_combine, el_long, el_calloc;
import dmd.backend.global;
// import dmd.backend.obj : ;
import dmd.backend.oper : OPvar, OPeqeq, OPaddr, OPind, OPcomma, OPeq, OPcall, OPadd, OPhalt, OPandand, OPnot;
import dmd.backend.rtlsym : RTLSYM_THROWDWARF, RTLSYM_THROWC, getRtlsym, RTLSYM_BEGIN_CATCH, RTLSYM_CXA_BEGIN_CATCH, RTLSYM_UNWIND_RESUME;
import dmd.backend.symtab : SYMIDX;
import dmd.backend.ty : TYbool, TYnptr, TYvoid, mTYvolatile, TYint, tym_t, TYsize_t, mTYnaked, tybasic, TYstruct, TYarray;
import dmd.backend.type : type_fake, tstypes, tspvoid, type;
