...
import core.stdc.stdio : fprintf, stderr, sprintf;
import core.stdc.stdlib : malloc, free;
import core.stdc.string : memcpy, strlen, strcmp;

import dmd.aggregate : AggregateDeclaration, Sizeok;
import dmd.arraytypes : Parameters, Expressions, Objects;
// import dmd.attrib : ;
import dmd.ast_node : ASTNode;
import dmd.gluelayer : type;
import dmd.dclass : ClassDeclaration;
import dmd.declaration : TypeInfoDeclaration, STC, VarDeclaration;
...
import dmd.dtemplate : TemplateDeclaration, TemplateInstance, getDsymbol;
import dmd.errors : error, deprecation;
import dmd.expression : Expression, TraitsExp, IntegerExp, ErrorExp, VectorExp, ArrayLiteralExp, VarExp, DotIdExp, CallExp, StringExp, StructLiteralExp, IdentifierExp;
import dmd.expressionsem : trySemantic;
import dmd.func : resolveFuncCall, FuncResolveFlag, FuncDeclaration;
import dmd.globals : d_uns64, StorageClass, Loc, dinteger_t, MATCH, structalign_t, uinteger_t, global, LINK, CPPMANGLE, STRUCTALIGN_DEFAULT;
import dmd.hdrgen : HdrGenState, toCBuffer, parameterToChars, trustToString;
import dmd.id : Id;
...
import dmd.root.rmem : mem, Mem, Pool;
import dmd.root.rootobject : RootObject, DYNCAST;
import dmd.root.stringtable : StringTable;
import dmd.target : target;
import dmd.tokens : Token, TOK;
import dmd.typesem : typeSemantic, merge, defaultInit, resolve;
