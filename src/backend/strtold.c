...
// Note that the [sizeof(long_double)] takes care of whatever the 0 padding is for the
// target platform

static unsigned char _negtab_bytes[][sizeof(long_double)] =
...
static unsigned char _postab_bytes[][sizeof(long_double)] =
...
static long_double *negtab = (long_double *) _negtab_bytes;
static long_double *postab = (long_double *) _postab_bytes;
...
extern "C" long_double strtold(const char *p,char **endp);
