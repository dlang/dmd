...
void ScopeDsymbol::acceptVisitor(Visitor *v)
{
    v->visit(this);
} 

void WithScopeSymbol::acceptVisitor(Visitor *v)
{
    v->visit(this);
} 

void ArrayScopeSymbol::acceptVisitor(Visitor *v)
{
    v->visit(this);
} 

void OverloadSet::acceptVisitor(Visitor *v)
{
    v->visit(this);
} 
