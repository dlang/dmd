 ...
 * Source:      $(LINK2 https://github.com/dlang/dmd/blob/master/compiler/src/dmd/irgen/todt.d, _todt.d)
 * Documentation:  https://dlang.org/phobos/dmd_irgen_todt.html
 * Coverage:    https://codecov.io/gh/dlang/dmd/src/master/compiler/src/dmd/irgen/todt.d
 */

module dmd.irgen.todt;
    ...
    void visitString(StringExp e)
    {
        ...
        switch (t.ty)
        {
            ...
            case Tpointer:
                if (e.sz == 1)
                {
                    import dmd.irgen.e2ir : toStringSymbol;
                    import dmd.irgen : totym;
