    ...
    if (sz == 1)                  // must have byte regs
    {
        ...
        if (!retregs)
           ...
           (
             ...
             (e1.Eoper == OPvar && e1.Vsym.Sfl == FLfardata)
           )
          )
        ...
        case OPconst:
          ...
          L4:
            ...
            if (sz == 1)
            {
                ...
                if (reg & 8)
                    cs.Irex |= REX_B;
                if (e1.Eoper == OPvar && e1.Voffset == 1 && e1.Vsym.Sfl == FLreg)
                {   assert(reg < 4);
...
void cdcmpxchg(ref CodeBuilder cdb, elem *e, regm_t *pretregs)
{
    ...
    if (I32 && sz == 8)
    {
        ...
        codelem(cdb,e2.E1,&retregsx,false);          // [DX,AX] = e2.E1
    ...
    else
    {
        ...
        regm_t retregsx = mAX;
        codelem(cdb,e2.E1,&retregsx,false);       // AX = e2.E1
