 ...
 *    m = module to scan
 */
public void inlineScanModule(Module m) nothrow
{
...
private void inlineScanDsymbol(Dsymbol s) nothrow
{
 ...
 */
public Expression inlineCopy(Expression e, Scope* sc) nothrow
{
 ...
 */
private bool canInline(FuncDeclaration fd, bool hasthis, bool hdrscan, bool statementsToo) nothrow
{
    int cost;
...
private void expandInline(Loc callLoc, FuncDeclaration fd, FuncDeclaration parent, Expression eret,
        ...
        out Expression eresult, out Statement sresult, out bool again) nothrow
{
 ...
 */
private bool isConstruction(Expression e) nothrow
{
    e = lastComma(e);
 ...
 */
private bool onlyOneAssign(VarDeclaration v, FuncDeclaration fd) nothrow @safe
{
    if (!v.type.isMutable())
...
private bool argumentsNeedDtors(Expressions* arguments) nothrow
{
    if (arguments)
    {
...
private bool expNeedsDtor(Expression exp) nothrow
{
