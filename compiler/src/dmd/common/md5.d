 ...
 *
 * This is  a copy of std.digest.md, but stripped of bells and whistles
 *
...
@safe unittest
{
    ...
    ubyte[3] data = [ 'a', 'b', 'c' ];
    md.put(data);
    ubyte[16] hash = md.finish();
    ubyte[16] refhash = [ 0x90, 0x01, 0x50, 0x98, 0x3C, 0xD2, 0x4F, 0xB0,
