...
unittest {
    ...
    assert(blake3(oneByte) == [0x2d,0x3a,0xde,0xdf,0xf1,0x1b,0x61,0xf1,
    ...
    assert(blake3(twoBlockInput) == [0xde,0x1e,0x5f,0xa0,0xbe,0x70,0xdf,0x6d,
    ...
    assert(blake3(barelyOneChunk) == [0x42,0x21,0x47,0x39,0xf0,0x95,0xa4,0x06,
    ...
    assert(blake3(barelyTwoChunks) == [0xd0,0x02,0x78,0xae,0x47,0xeb,0x27,0xb3,
    ...
    assert(blake3(bigInput) == [0x62,0xb6,0x96,0x0e,0x1a,0x44,0xbc,0xc1,
