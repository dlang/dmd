...
enum TOK : ubyte
{
    ...
    // C only keywords (postfixed with _ to avoid keword collision when generating
    // frontend.h with -HC)
    inline_,
    register_,
    restrict_,
...
() {
    with (TOK)
    {
        ...
        enum Ckwds = [ auto_, break_, case_, char_, const_, continue_, default_, do_, float64, else_,
                       enum_, extern_, float32, for_, goto_, if_, inline_, int32, int64, register_,
                       restrict_, return_, int16, signed_, sizeof_, static_, struct_, switch_, typedef_,
                       union_, unsigned_, void_, volatile_, while_, asm_, typeof_,
                       _Alignas_, _Alignof_, _Atomic_, _Bool_, _Complex_, _Generic_, _Imaginary_, _Noreturn_,
                       _Static_assert_, _Thread_local_,
                       _import_, __cdecl_, __declspec_, __stdcall_, __thread_, __pragma_, __int128_, __attribute___,
                       _assert_ ];
...
extern (C++) struct Token
{
    ...
    [
        ...
        // C only extended keywords
        TOK._assert_        : "__check",
        TOK._import_        : "__import",
        TOK.__cdecl_        : "__cdecl",
        TOK.__declspec_     : "__declspec",
        TOK.__stdcall_      : "__stdcall",
        TOK.__thread_       : "__thread",
        TOK.__pragma_       : "__pragma",
        TOK.__int128_       : "__int128",
        TOK.__attribute___  : "__attribute__",
    ];
