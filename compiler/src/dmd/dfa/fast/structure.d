 ...
 *
 * Instead of storing a single value, the Lattice stores a linked list of
 * `DFAConsequence` nodes. This allows the engine to track the evolution
 * of a variable's state and merge conflicting states (e.g., at the end of an if/else).
 */
struct DFALattice
{
    private
...
/***********************************************************
 * A specific fact known about a variable at a specific point.
 *
