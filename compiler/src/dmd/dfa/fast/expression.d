...
struct ExpressionWalker
{
    ...
    void seeConvergeExpression(DFALatticeRef lr)
    {
        ...
        lr.print("", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
        lr.check;

        analyzer.convergeExpression(lr);

        dfaCommon.currentDFAScope.print("so far", dfaCommon.sdepth,
            ...
            DFALatticeRef lr, bool isBlit = false)
    {
        dfaCommon.printState((ref OutBuffer ob,
                scope PrintPrefixType prefix) => ob.printf("Assigning construct?%d:%d\n",
                construct, isBlit));
        assignTo.print("to", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
        assignTo.check;
        lr.print("from", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
        lr.check;

        assert(analyzer !is null);
        DFALatticeRef ret = analyzer.transferAssign(assignTo, construct, isBlit, lr);
        ret.check;
        ret.print("result", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
        return ret;
    }
            ...
            Type lhsType, Type rhsType)
    {
        ...
        lhs.print("lhs", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
        rhs.print("rhs", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
    ...
    {
        lr.print("Negate", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
    ...
    DFALatticeRef seeDereference(ref Loc loc, DFALatticeRef lr)
    {
        ...
        lr.print("Dereference", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
    ...
    {
        lr.print("Assert", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);

        dfaCommon.currentDFAScope.print("scope", dfaCommon.sdepth,
                dfaCommon.currentFunction, dfaCommon.edepth);
        dfaCommon.currentDFAScope.check;
    ...
    {
        lr.print("Assert silent", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
            ...
            DFAScopeRef scrFalse, DFALatticeRef lrFalse)
    {
        ...
        scrTrue.print("true sc", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
        lrTrue.print("true lr", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
        scrFalse.print("false sc", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
        lrFalse.print("false lr", dfaCommon.sdepth, dfaCommon.currentFunction, dfaCommon.edepth);
    ...
    DFALatticeRef walk(Expression expr)
    {
        ...
        case EXP.cast_:
            ...
            else if (cctx.var !is null && cctx.var.isNullable && !isTypeNullable(ce.to))
            {
        ...
        case EXP.assign:
            ...
            if (lhsIndex !is null)
            {
                ...
                DFAConsequence* lhsCctx = lhs.getContext(lhsContextVar);
            ...
            this.seeConvergeExpression(ret.copy);
            return ret;
        ...
        case EXP.andAnd:
            ...
            DFAScopeRef scr = stmtWalker.endScope;
            stmtWalker.seeConvergeStatement(scr);
        ...
        case EXP.orOr:
            ...
            while (be !is null)
            {
                ...
                DFALatticeRef toNegate = this.seeNegate(lhs.copy, true);
                ...
                this.seeConvergeExpression(toNegate);
            ...
            inProgressScr = stmtWalker.seeLoopyLabelAwareStage(inProgressScr, stmtWalker.endScope);
            stmtWalker.seeConvergeStatement(inProgressScr);
            return inProgress;
        ...
        case EXP.concatenateDcharAssign:
            ...
            if (nullableResult == 1 || nullableResult == 2)
            {
            ...
            DFAConsequence* cctx = ret.addConsequence(lhsCtx);
            ret.setContext(cctx);
        ...
        case EXP.prePlusPlus:
            ...
            const lhsTruthy = lhsCctx !is null ? lhsCctx.truthiness : Truthiness.Unknown;
            const rhsTruthy = rhsCctx !is null ? rhsCctx.truthiness : Truthiness.Unknown;

            DFALatticeRef ret = seeAssign(lhs, false, rhs);
            if (ret.isNull)
                ret = dfaCommon.makeLatticeRef;

            DFAConsequence* cctx = ret.addConsequence(lhsVar);

            if ((lhsTruthy == Truthiness.False && rhsTruthy == Truthiness.True)
                    || (lhsTruthy == Truthiness.True && rhsTruthy > Truthiness.Maybe))
                cctx.truthiness = Truthiness.True;
            else
                cctx.truthiness = Truthiness.Unknown;

            DFALatticeRef effect = dfaCommon.makeLatticeRef;
            cctx = effect.addConsequence(lhsVar, cctx);
            effect.setContext(cctx);

            this.seeConvergeExpression(effect);
            return ret;
        ...
        case EXP.preMinusMinus:
            ...
            DFALatticeRef effect = dfaCommon.makeLatticeRef;
            DFAConsequence* cctx = effect.addConsequence(lhsVar);
            effect.setContext(cctx);
        ...
        case EXP.question:
            ...
            dfaCommon.printState((ref OutBuffer ob, scope PrintPrefixType prefix) {
                ...
                ob.writestring("Question true branch\n");
            });
