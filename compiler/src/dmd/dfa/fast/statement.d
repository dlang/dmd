...
final:
            ...
            DFAScopeRef scrFalse, bool haveFalseBody, bool unknownBranchTaken)
    {
        dfaCommon.printStructure((ref OutBuffer ob, scope PrintPrefixType prefix) => ob.printf(
                "Converging statement if %d %d:\n", haveFalseBody, unknownBranchTaken));
    ...
    extern (C++) override void visit(Statement st)
    {
        ...
        */
        ...
        case STMT.If:
            ...
            this.startScope;
            DFALatticeRef condition;
            bool ignoreTrueBranch, ignoreFalseBranch;
            bool unknownBranchTaken;

            {
                condition = expWalker.conditional(ifs.condition, true);
                ...
                if (!ignoreTrueBranch)
                    expWalker.seeAssert(condition.copy, ifs.condition.loc, true);
            }
...

            {
                ...
                {
                    DFALatticeRef condition2 = expWalker.conditional(ifs.condition, false);
                    expWalker.seeSilentAssert(condition2, false, true);
                ...
                else
                {
                    ...
                    DFALatticeRef condition2 = expWalker.conditional(ifs.condition, false);
                    expWalker.seeSilentAssert(condition2, true, true);
                }
            ...
            seeConvergeStatementIf(condition, ifbody, elsebody, haveFalseBody, unknownBranchTaken);
            break;
            ...
            */
...

            {
...

                {
                    ...
                    DFALatticeRef lrCondition = expWalker.conditional(theCondition, true);
                ...
                DFALatticeRef lrCondition = expWalker.conditional(theCondition, false);
