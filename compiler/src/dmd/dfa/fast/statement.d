    ...
    extern (C++) override void visit(Statement st)
    {
        ...
        */
        ...
        case STMT.Exp:
            ...
            DFALatticeRef lr = walkExpression(null, null, exp);
            seeRead(lr, exp.loc);
        ...
        case STMT.For:
            ...
            */
            ...
            if (theCondition !is null)
            {
                ...
                lrConditionTrue = expWalker.adaptConditionForBranch(lrCondition.copy, theCondition.type, true);
        ...
        case STMT.Do:
            ...
            const expectedToContinue = lrCondition.isNull || lrCondition.getContext().truthiness != Truthiness.False;
            expWalker.seeSilentAssert(lrCondition, false, true);

            // cannot use isBranchTaken as it'll care about the statement which is guaranteed to be used.
            if (expectedToContinue)
                dfaCommon.currentDFAScope.haveJumped = true;
