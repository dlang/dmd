...
struct DFACommon
{
    ...
    DFAScopeRef popScope()
    {
        ...
        if (currentDFAScope is null)
        {
            foreach (ref bucket; forwardLabels)
            {
                while (bucket !is null)
                {
                    DFALabelState* next = bucket.next;

                    bucket.scr = DFAScopeRef.init;
...
struct DFAAllocator
{
    private
    {
        ...
        DFALabelState* allocatedlistlabel, allocatedlistlastlabel;
    }
    ...
    ~this()
    {
        ...
        if (allocatedlistlabel !is null)
        {
            allocatedlistlastlabel.listnext = freelistlabel;
            freelistlabel = allocatedlistlabel;
        }
    }
    ...
    {
        DFAScopeVar* ret = freelistscopevar;
    ...
    {
        DFALattice* ret = freelistlattice;
        ...
        {
            freelistlattice = ret.freelistnext;
        }
    ...
    {
        DFAConsequence* ret = freelistconsequence;
    ...
    DFALabelState* makeLabelState(Identifier ident)
    {
        ...
        if (freelistlabel is null)
        {
            ret = new DFALabelState;
        }
        else
        {
            ret = freelistlabel;
            freelistlabel = ret.listnext;
        }

        ret.ident = ident;

        ret.listnext = allocatedlistlabel;
        allocatedlistlabel = ret;

        if (allocatedlistlastlabel is null)
            allocatedlistlastlabel = ret;
        return ret;
    }
    ...
    void free(DFALattice* l)
    {
        ...
        l.freelistnext = freelistlattice;
        freelistlattice = l;
    }

    void free(DFAConsequence* c)
    {
        c.freelistnext = freelistconsequence;
    ...
    void check()
    {
        debug
        {
...

            {
                ...
                while (temp !is null)
                {
                    assert(temp.freelistnext is null);
                    temp = temp.next;
                }
            }
