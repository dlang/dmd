        ...
        elem* ethis2 = null)    // multi-context array
{
    ...
    if (!tf)
    {
        ...
        {
            // Copy the delegate into a temporary variable for the null check
            // This simplifies the IR down to be easier to analyze.
            Symbol* stmp = symbol_genauto(type_fake(ec.Ety));
    ...
    if (arguments && arguments.length)
    {
        ...
        {
            eside = el_combine(eside, fixArgumentEvaluationOrder(elems));
        }
