...
public:
    ...
    virtual void importScope(Dsymbol* s, Visibility visibility, Import* imp = nullptr);
...
public:
    ...
    void importScope(Dsymbol* s, Visibility visibility, Import* imp = nullptr) override;
    const char* kind() const override;
...
class UnusedImportVisitor : public SemanticTimeTransitiveVisitor
{
public:
