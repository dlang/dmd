 ...
 * Source:      $(LINK2 https://github.com/dlang/dmd/blob/master/compiler/src/dmd/mars.d, _hostcompiler.d)
 * Documentation:  https://dlang.org/phobos/dmd_hostcompiler.html
 * Coverage:    https://codecov.io/gh/dlang/dmd/src/master/compiler/src/dmd/hostcompiler.d
 */

module dmd.hostcompiler;
...
version (IN_GCC)
{
    enum HostCompiler = "GNU D";      // compiler being built
...
{
    enum HostCompiler = "Digital Mars D";
    enum SwitchPrefix = "";
    enum SwitchVariadic = "betterC";
    enum const(char)* SwitchExceptions = null;
}
