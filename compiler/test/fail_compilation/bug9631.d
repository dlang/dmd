...
TEST_OUTPUT:
---
fail_compilation/bug9631.d(79): Error: function `f` is not callable using argument types `(int, S)`
fail_compilation/bug9631.d(79):        cannot pass argument `y` of type `bug9631.tem!().S` to parameter `bug9631.S s`
fail_compilation/bug9631.d(78):        `bug9631.arg.f(int i, S s)` declared here
...
TEST_OUTPUT:
---
fail_compilation/bug9631.d(106): Error: function `ft` is not callable using argument types `(S)`
fail_compilation/bug9631.d(106):        cannot pass argument `x` of type `bug9631.S` to parameter `bug9631.tem!().S __param_0`
fail_compilation/bug9631.d(105):        `bug9631.targ.ft!().ft(S __param_0)` declared here
fail_compilation/bug9631.d(107): Error: template `ft` is not callable using argument types `!()(S)`
fail_compilation/bug9631.d(105):        Candidate is: `ft()(tem!().S)`
fail_compilation/bug9631.d(109): Error: template `ft2` is not callable using argument types `!()(S, int)`
