...
TEST_OUTPUT:
---
fail_compilation/named_arguments_error.d(32): Error: function `f` is not callable using argument types `(int, int, int)`
fail_compilation/named_arguments_error.d(32):        parameter `x` assigned twice
fail_compilation/named_arguments_error.d(26):        `named_arguments_error.f(int x, int y, int z)` declared here
fail_compilation/named_arguments_error.d(33): Error: function `f` is not callable using argument types `(int, int, int)`
fail_compilation/named_arguments_error.d(33):        argument `4` goes past end of parameter list
fail_compilation/named_arguments_error.d(26):        `named_arguments_error.f(int x, int y, int z)` declared here
fail_compilation/named_arguments_error.d(34): Error: function `f` is not callable using argument types `(int, int, int)`
fail_compilation/named_arguments_error.d(34):        parameter `y` assigned twice
fail_compilation/named_arguments_error.d(26):        `named_arguments_error.f(int x, int y, int z)` declared here
fail_compilation/named_arguments_error.d(35): Error: function `f` is not callable using argument types `(int, int, int)`
fail_compilation/named_arguments_error.d(35):        no parameter named `a`
fail_compilation/named_arguments_error.d(26):        `named_arguments_error.f(int x, int y, int z)` declared here
fail_compilation/named_arguments_error.d(36): Error: function `g` is not callable using argument types `(int, int)`
fail_compilation/named_arguments_error.d(36):        missing argument for parameter #1: `int x`
fail_compilation/named_arguments_error.d(28):        `named_arguments_error.g(int x, int y, int z = 3)` declared here
...
fail_compilation/named_arguments_error.d(41): Error: template `tempfun` is not callable using argument types `!()(string, int)`
