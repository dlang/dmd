...
fail_compilation/diag8101b.d(31): Error: function `bar` is not callable using argument types `(double)`
...
fail_compilation/diag8101b.d(34): Error: none of the overloads of `foo` are callable using a `const` object with argument types `(int)`
fail_compilation/diag8101b.d(20):        Candidates are: `diag8101b.S.foo(int __param_0)`
fail_compilation/diag8101b.d(21):                        `diag8101b.S.foo(int __param_0, int __param_1)`
fail_compilation/diag8101b.d(36): Error: mutable method `diag8101b.S.bar` is not callable using a `const` object
fail_compilation/diag8101b.d(23):        Consider adding `const` or `inout` here
---
*/
