...
fail_compilation/traits.d(300):        `float` must evaluate to either a module, a struct, a union, a class, an interface or a template instantiation
...
fail_compilation/traits.d(306):        `TemplatedStruct(T)` must evaluate to either a module, a struct, a union, a class, an interface or a template instantiation
fail_compilation/traits.d(309): Error: in expression `__traits(derivedMembers, float)` `float` can't have members
fail_compilation/traits.d(309):        `float` must evaluate to either a module, a struct, a union, a class, an interface or a template instantiation
...
fail_compilation/traits.d(316):        `TemplatedStruct(T)` must evaluate to either a module, a struct, a union, a class, an interface or a template instantiation
