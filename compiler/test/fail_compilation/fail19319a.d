...
TEST_OUTPUT:
---
fail_compilation/fail19319a.d(16): Error: `7 ^^ g19319` requires `core.math` for `^^` operators
fail_compilation/fail19319a.d(17): Error: `g19319 ^^ 7` requires `core.math` for `^^` operators
---
*/
