...
fail_compilation/b20011.d(37): Error: function is not callable using argument types `(ubyte)`
fail_compilation/b20011.d(37):          `b20011.main.assignableByRef(ref ubyte p)`
fail_compilation/b20011.d(37):        cannot pass rvalue argument `S1(cast(ubyte)0u).member` of type `ubyte` to parameter `ref ubyte p`
fail_compilation/b20011.d(38): Error: function is not callable using argument types `(ubyte)`
fail_compilation/b20011.d(38):          `b20011.main.assignableByOut(out ubyte p)`
fail_compilation/b20011.d(38):        cannot pass rvalue argument `S1(cast(ubyte)0u).member` of type `ubyte` to parameter `out ubyte p`
fail_compilation/b20011.d(39): Error: function is not callable using argument types `(ubyte)`
fail_compilation/b20011.d(39):          `b20011.main.assignableByConstRef(ref const(ubyte) p)`
